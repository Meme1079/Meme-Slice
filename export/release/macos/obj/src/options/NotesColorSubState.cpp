...
void NotesColorSubState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1dccb24f48fccdae_186_update)
...
HXDLIN( 198)				_hx_tmp2 = ((_this->viewX - _this->_prevViewX) != 0);
            			}
            			else {
...
HXDLIN( 198)				_hx_tmp1 = ((_this1->viewY - _this1->_prevViewY) != 0);
            			}
            			else {
...
HXDLIN( 459)							Float y1 = (y + (this->colorWheel->get_height() / ( (Float)(2) )));
HXDLIN( 459)							 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 459)							point->_inPool = false;
HXDLIN( 459)							 ::flixel::math::FlxBasePoint center = point;
HXLINE( 460)							 ::flixel::math::FlxBasePoint mouse = this->pointerFlxPoint();
HXLINE( 461)							Float x2 = (center->x - mouse->x);
HXDLIN( 461)							Float y2 = (center->y - mouse->y);
HXDLIN( 461)							Float hue = ( (Float)(::flixel::math::FlxMath_obj::wrap((::flixel::math::FlxMath_obj::wrap(::Std_obj::_hx_int((::Math_obj::atan2(y2,x2) * (( (Float)(180) ) / ::Math_obj::PI))),0,360) - 90),0,360)) );
HXLINE( 462)							Float x3 = center->x;
HXDLIN( 462)							Float y3 = center->y;
HXDLIN( 462)							Float result = ::Math_obj::sqrt((((mouse->x - x3) * (mouse->x - x3)) + ((mouse->y - y3) * (mouse->y - y3))));
HXDLIN( 462)							{
...
HXDLIN( 462)							Float Value7 = ((result / this->colorWheel->get_width()) * ( (Float)(2) ));
HXDLIN( 462)							Float lowerBound1;
HXDLIN( 462)							if ((Value7 < 0)) {
HXLINE( 462)								lowerBound1 = ( (Float)(0) );
            							}
            							else {
HXLINE( 462)								lowerBound1 = Value7;
            							}
...
HXDLIN( 465)								{
HXLINE( 465)									int Value8 = ::Math_obj::round((Red * ( (Float)(255) )));
HXDLIN( 465)									color5 = (color5 & -16711681);
HXDLIN( 465)									int color6;
HXDLIN( 465)									if ((Value8 > 255)) {
HXLINE( 465)										color6 = 255;
            									}
            									else {
HXLINE( 465)										if ((Value8 < 0)) {
HXLINE( 465)											color6 = 0;
            										}
            										else {
HXLINE( 465)											color6 = Value8;
            										}
            									}
HXDLIN( 465)									color5 = (color5 | (color6 << 16));
            								}
HXDLIN( 465)								{
HXLINE( 465)									int Value9 = ::Math_obj::round((Green * ( (Float)(255) )));
...
HXLINE( 465)											color7 = Value9;
            										}
            									}
HXDLIN( 465)									color5 = (color5 | (color7 << 8));
            								}
HXDLIN( 465)								{
HXLINE( 465)									int Value10 = ::Math_obj::round((Blue * ( (Float)(255) )));
...
HXLINE( 465)											color8 = Value10;
            										}
            									}
HXDLIN( 465)									color5 = (color5 | color8);
            								}
HXDLIN( 465)								{
HXLINE( 465)									int Value11 = ::Math_obj::round((Alpha1 * ( (Float)(255) )));
...
void NotesColorSubState_obj::updateNotes( ::Dynamic __o_instant){
            	...
            	HX_STACKFRAME(&_hx_pos_1dccb24f48fccdae_660_updateNotes)
HXLINE( 661)		{
HXLINE( 661)			 ::Dynamic filter = null();
HXDLIN( 661)			::Array< ::Dynamic> _g__groupMembers = this->modeNotes->members;
HXDLIN( 661)			 ::Dynamic _g__filter = filter;
HXDLIN( 661)			int _g__cursor = 0;
HXDLIN( 661)			int _g__length = _g__groupMembers->length;
HXDLIN( 661)			while(true){
HXLINE( 661)				while(true){
HXLINE( 661)					bool _hx_tmp;
HXDLIN( 661)					if ((_g__cursor < _g__length)) {
HXLINE( 661)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 661)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 661)								_hx_tmp = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
...
HXLINE( 661)						goto _hx_goto_30;
            					}
HXDLIN( 661)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_30:;
HXDLIN( 661)				if (!((_g__cursor < _g__length))) {
HXLINE( 661)					goto _hx_goto_29;
            				}
HXDLIN( 661)				 ::flixel::FlxSprite note;
HXDLIN( 661)				while(true){
HXLINE( 661)					bool note1;
HXDLIN( 661)					if ((_g__cursor < _g__length)) {
HXLINE( 661)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 661)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 661)								note1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
HXLINE( 661)								note1 = false;
            							}
            						}
            						else {
HXLINE( 661)							note1 = true;
            						}
            					}
            					else {
HXLINE( 661)						note1 = false;
...
HXDLIN( 661)					_g__cursor = (_g__cursor + 1);
            				...
            				_hx_goto_31:;
HXDLIN( 661)				if ((_g__cursor < _g__length)) {
HXLINE( 661)					_g__cursor = (_g__cursor + 1);
HXDLIN( 661)					note = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::FlxSprite >();
            				}
            				else {
HXLINE( 661)					note = null();
            				}
HXDLIN( 661)				 ::flixel::FlxSprite note2 = note;
HXLINE( 662)				Float _hx_tmp1;
HXDLIN( 662)				if ((this->curSelectedMode == note2->ID)) {
HXLINE( 662)					_hx_tmp1 = ( (Float)(1) );
            				}
            				else {
HXLINE( 662)					_hx_tmp1 = ((Float)0.6);
            				}
HXDLIN( 662)				note2->set_alpha(_hx_tmp1);
            			}
            			_hx_goto_29:;
            		}
HXLINE( 664)		{
HXLINE( 664)			 ::Dynamic filter1 = null();
HXDLIN( 664)			::Array< ::Dynamic> _g__groupMembers1 = this->myNotes->members;
HXDLIN( 664)			 ::Dynamic _g__filter1 = filter1;
HXDLIN( 664)			int _g__cursor1 = 0;
HXDLIN( 664)			int _g__length1 = _g__groupMembers1->length;
HXDLIN( 664)			while(true){
HXLINE( 664)				while(true){
HXLINE( 664)					bool _hx_tmp2;
HXDLIN( 664)					if ((_g__cursor1 < _g__length1)) {
HXLINE( 664)						if (::hx::IsNotNull( _g__groupMembers1->__get(_g__cursor1).StaticCast<  ::objects::StrumNote >() )) {
HXLINE( 664)							if (::hx::IsNotNull( _g__filter1 )) {
HXLINE( 664)								_hx_tmp2 = !(( (bool)(_g__filter1(_g__groupMembers1->__get(_g__cursor1).StaticCast<  ::objects::StrumNote >())) ));
            							}
            							else {
...
HXLINE( 664)						goto _hx_goto_33;
            					}
HXDLIN( 664)					_g__cursor1 = (_g__cursor1 + 1);
            				}
            				_hx_goto_33:;
HXDLIN( 664)				if (!((_g__cursor1 < _g__length1))) {
HXLINE( 664)					goto _hx_goto_32;
            				}
HXDLIN( 664)				 ::objects::StrumNote note3;
HXDLIN( 664)				while(true){
HXLINE( 664)					bool note4;
HXDLIN( 664)					if ((_g__cursor1 < _g__length1)) {
HXLINE( 664)						if (::hx::IsNotNull( _g__groupMembers1->__get(_g__cursor1).StaticCast<  ::objects::StrumNote >() )) {
HXLINE( 664)							if (::hx::IsNotNull( _g__filter1 )) {
HXLINE( 664)								note4 = !(( (bool)(_g__filter1(_g__groupMembers1->__get(_g__cursor1).StaticCast<  ::objects::StrumNote >())) ));
            							}
            							else {
HXLINE( 664)								note4 = false;
            							}
            						}
            						else {
HXLINE( 664)							note4 = true;
            						}
            					}
            					else {
HXLINE( 664)						note4 = false;
...
HXDLIN( 664)					_g__cursor1 = (_g__cursor1 + 1);
            				...
            				_hx_goto_34:;
HXDLIN( 664)				if ((_g__cursor1 < _g__length1)) {
HXLINE( 664)					_g__cursor1 = (_g__cursor1 + 1);
HXDLIN( 664)					note3 = _g__groupMembers1->__get((_g__cursor1 - 1)).StaticCast<  ::objects::StrumNote >();
            				}
            				else {
HXLINE( 664)					note3 = null();
            				}
HXDLIN( 664)				 ::objects::StrumNote note5 = note3;
HXLINE( 666)				::String newAnim;
HXDLIN( 666)				if ((this->curSelectedNote == note5->ID)) {
HXLINE( 666)					newAnim = HX_("confirm",00,9d,39,10);
            				}
            				else {
HXLINE( 666)					newAnim = HX_("pressed",a2,d2,e6,39);
            				}
HXLINE( 667)				Float _hx_tmp3;
HXDLIN( 667)				if ((this->curSelectedNote == note5->ID)) {
HXLINE( 667)					_hx_tmp3 = ( (Float)(1) );
            				}
            				else {
HXLINE( 667)					_hx_tmp3 = ((Float)0.6);
            				}
HXDLIN( 667)				note5->set_alpha(_hx_tmp3);
HXLINE( 668)				bool _hx_tmp4;
HXDLIN( 668)				if (::hx::IsNotNull( note5->animation->_curAnim )) {
HXLINE( 668)					_hx_tmp4 = (note5->animation->_curAnim->name != newAnim);
            				}
            				else {
HXLINE( 668)					_hx_tmp4 = true;
            				}
HXDLIN( 668)				if (_hx_tmp4) {
HXLINE( 668)					note5->playAnim(newAnim,true);
            				}
HXLINE( 669)				if (( (bool)(instant) )) {
HXLINE( 669)					note5->animation->_curAnim->finish();
            				}
            			}
            			_hx_goto_32:;
            		}
