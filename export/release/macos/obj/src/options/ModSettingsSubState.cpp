...
HXDLIN( 167)			goto _hx_goto_6;
            		...
            		_hx_goto_6:;
HXLINE( 171)		::flixel::FlxG_obj::log->advanced((HX_("Could not find option type: ",50,4b,94,7c) + str),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("source/options/ModSettingsSubState.hx",0d,c7,6e,02),171,HX_("options.ModSettingsSubState",26,9a,f1,f8),HX_("convertType",4d,92,4d,36)));
