...
void BaseOptionsMenu_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_11861b212311743c_476_changeSelection)
...
HXDLIN( 489)			::Array< ::Dynamic> _g__groupMembers = this->grpTexts->members;
HXDLIN( 489)			 ::Dynamic _g__filter = filter;
HXDLIN( 489)			int _g__cursor = 0;
HXDLIN( 489)			int _g__length = _g__groupMembers->length;
HXDLIN( 489)			while(true){
HXLINE( 489)				while(true){
HXLINE( 489)					bool _hx_tmp4;
HXDLIN( 489)					if ((_g__cursor < _g__length)) {
HXLINE( 489)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::AttachedText >() )) {
HXLINE( 489)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 489)								_hx_tmp4 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::AttachedText >())) ));
            							}
            							else {
...
HXLINE( 489)						goto _hx_goto_15;
            					}
HXDLIN( 489)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_15:;
HXDLIN( 489)				if (!((_g__cursor < _g__length))) {
HXLINE( 489)					goto _hx_goto_14;
            				}
HXDLIN( 489)				 ::objects::AttachedText text;
HXDLIN( 489)				while(true){
HXLINE( 489)					bool text1;
HXDLIN( 489)					if ((_g__cursor < _g__length)) {
HXLINE( 489)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::AttachedText >() )) {
HXLINE( 489)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 489)								text1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::AttachedText >())) ));
            							}
            							else {
HXLINE( 489)								text1 = false;
            							}
            						}
            						else {
HXLINE( 489)							text1 = true;
            						}
            					}
            					else {
HXLINE( 489)						text1 = false;
...
HXDLIN( 489)					if (!(text1)) {
HXLINE( 489)						goto _hx_goto_16;
            					}
HXDLIN( 489)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_16:;
HXDLIN( 489)				if ((_g__cursor < _g__length)) {
HXLINE( 489)					_g__cursor = (_g__cursor + 1);
HXDLIN( 489)					text = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::objects::AttachedText >();
            				}
            				else {
HXLINE( 489)					text = null();
            				}
HXDLIN( 489)				 ::objects::AttachedText text2 = text;
HXLINE( 491)				text2->set_alpha(((Float)0.6));
HXLINE( 492)				if ((text2->ID == this->curSelected)) {
HXLINE( 492)					text2->set_alpha(( (Float)(1) ));
            				}
            			}
            			_hx_goto_14:;
            		}
HXLINE( 495)		this->descBox->setPosition((this->descText->x - ( (Float)(10) )),(this->descText->y - ( (Float)(10) )));
HXLINE( 496)		 ::flixel::FlxSprite _hx_tmp5 = this->descBox;
HXDLIN( 496)		int _hx_tmp6 = ::Std_obj::_hx_int((this->descText->get_width() + 20));
HXDLIN( 496)		_hx_tmp5->setGraphicSize(_hx_tmp6,::Std_obj::_hx_int((this->descText->get_height() + 25)));
...
HXLINE( 500)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp7 = ::flixel::FlxG_obj::sound;
HXDLIN( 500)		_hx_tmp7->play(::backend::Paths_obj::returnSound((HX_("sounds/",eb,02,a5,b6) + HX_("scrollMenu",4c,d4,18,06)),null(),true,null()),null(),null(),null(),null(),null());
            	}
...
void BaseOptionsMenu_obj::reloadCheckboxes(){
            	HX_STACKFRAME(&_hx_pos_11861b212311743c_504_reloadCheckboxes)
HXDLIN( 504)		 ::Dynamic filter = null();
HXDLIN( 504)		::Array< ::Dynamic> _g__groupMembers = this->checkboxGroup->members;
HXDLIN( 504)		 ::Dynamic _g__filter = filter;
HXDLIN( 504)		int _g__cursor = 0;
HXDLIN( 504)		int _g__length = _g__groupMembers->length;
HXDLIN( 504)		while(true){
HXDLIN( 504)			while(true){
HXDLIN( 504)				bool _hx_tmp;
HXDLIN( 504)				if ((_g__cursor < _g__length)) {
HXDLIN( 504)					if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::CheckboxThingie >() )) {
HXDLIN( 504)						if (::hx::IsNotNull( _g__filter )) {
HXDLIN( 504)							_hx_tmp = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::CheckboxThingie >())) ));
            						}
            						else {
...
HXDLIN( 504)					goto _hx_goto_19;
            				}
HXDLIN( 504)				_g__cursor = (_g__cursor + 1);
            			}
            			_hx_goto_19:;
HXDLIN( 504)			if (!((_g__cursor < _g__length))) {
HXDLIN( 504)				goto _hx_goto_18;
            			}
HXDLIN( 504)			 ::objects::CheckboxThingie checkbox;
HXDLIN( 504)			while(true){
HXDLIN( 504)				bool checkbox1;
HXDLIN( 504)				if ((_g__cursor < _g__length)) {
HXDLIN( 504)					if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::CheckboxThingie >() )) {
HXDLIN( 504)						if (::hx::IsNotNull( _g__filter )) {
HXDLIN( 504)							checkbox1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::CheckboxThingie >())) ));
            						}
            						else {
HXDLIN( 504)							checkbox1 = false;
            						}
            					}
            					else {
HXDLIN( 504)						checkbox1 = true;
            					}
            				}
            				else {
HXDLIN( 504)					checkbox1 = false;
            				}
HXDLIN( 504)				if (!(checkbox1)) {
...
HXDLIN( 504)			if ((_g__cursor < _g__length)) {
HXDLIN( 504)				_g__cursor = (_g__cursor + 1);
HXDLIN( 504)				checkbox = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::objects::CheckboxThingie >();
            			}
            			else {
HXDLIN( 504)				checkbox = null();
            			}
HXDLIN( 504)			 ::objects::CheckboxThingie checkbox2 = checkbox;
HXLINE( 505)			checkbox2->set_daValue((::Std_obj::string(this->optionsArray->__get(checkbox2->ID).StaticCast<  ::options::Option >()->getValue()) == HX_("true",4e,a7,03,4d)));
            		}
            		_hx_goto_18:;
            	}
