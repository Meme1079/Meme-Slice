...
HX_DEFINE_STACK_FRAME(_hx_pos_fa894d9ba0ae7f9c_33_new,"haxe.iterators.DynamicAccessIterator","new",0x44a637b2,"haxe.iterators.DynamicAccessIterator.new","/usr/local/lib/haxe/std/haxe/iterators/DynamicAccessIterator.hx",33,0x97300323)
HX_LOCAL_STACK_FRAME(_hx_pos_fa894d9ba0ae7f9c_43_hasNext,"haxe.iterators.DynamicAccessIterator","hasNext",0x6a341dbf,"haxe.iterators.DynamicAccessIterator.hasNext","/usr/local/lib/haxe/std/haxe/iterators/DynamicAccessIterator.hx",43,0x97300323)
HX_LOCAL_STACK_FRAME(_hx_pos_fa894d9ba0ae7f9c_50_next,"haxe.iterators.DynamicAccessIterator","next",0xccca8561,"haxe.iterators.DynamicAccessIterator.next","/usr/local/lib/haxe/std/haxe/iterators/DynamicAccessIterator.hx",50,0x97300323)
namespace haxe{
namespace iterators{

void DynamicAccessIterator_obj::__construct( ::Dynamic access){
            	HX_STACKFRAME(&_hx_pos_fa894d9ba0ae7f9c_33_new)
...
bool DynamicAccessIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_fa894d9ba0ae7f9c_43_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(DynamicAccessIterator_obj,hasNext,return )
 ...
 ::Dynamic DynamicAccessIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_fa894d9ba0ae7f9c_50_next)
