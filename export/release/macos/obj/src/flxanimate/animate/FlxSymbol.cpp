...
HXLINE( 106)			::flixel::FlxG_obj::log->advanced(HX_("this callback already exists!",e4,8f,bf,fc),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxSymbol.hx",02,0c,c6,a6),106,HX_("flxanimate.animate.FlxSymbol",7e,1d,82,8c),HX_("addCallbackTo",21,e8,7d,ab)));
...
HXLINE( 138)			::flixel::FlxG_obj::log->advanced(HX_("this callback doesn't exist!",e1,6e,3f,2b),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxSymbol.hx",02,0c,c6,a6),138,HX_("flxanimate.animate.FlxSymbol",7e,1d,82,8c),HX_("removeCallbackFrom",33,70,89,b1)));
            		}
...
HXLINE( 196)			::flixel::FlxG_obj::log->advanced(((HX_("The frame label \"",f4,cf,00,2a) + name) + HX_("\" does not exist! maybe you misspelled it?",dd,3e,3a,77)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxSymbol.hx",02,0c,c6,a6),196,HX_("flxanimate.animate.FlxSymbol",7e,1d,82,8c),HX_("getFrameLabel",bd,9e,47,af)));
            		}
...
HXLINE( 373)			::flixel::FlxG_obj::log->advanced(HX_("oldElement doesnt exist in this symbol!",43,e4,8c,7b),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxSymbol.hx",02,0c,c6,a6),373,HX_("flxanimate.animate.FlxSymbol",7e,1d,82,8c),HX_("swapElements",ea,67,ad,f3)));
HXLINE( 374)			return;
            		}
