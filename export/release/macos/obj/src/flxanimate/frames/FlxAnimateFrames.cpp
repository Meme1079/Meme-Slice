...
HXLINE(  77)			::flixel::FlxG_obj::log->advanced(HX_("the Frames parsing couldn't parse any of the frames, it's completely empty! \n Maybe you misspelled the Path?",ff,0a,77,40),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flxanimate/frames/FlxAnimateFrames.hx",20,95,16,11),77,HX_("flxanimate.frames.FlxAnimateFrames",3e,8a,4b,fc),HX_("fromTextureAtlas",fa,62,e9,b8)));
