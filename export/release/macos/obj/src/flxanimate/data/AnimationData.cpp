...
HXDLIN(  78)			_this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flxanimate/data/AnimationData.hx",35,24,37,a9),78,HX_("flxanimate.data.AnimationData",89,36,82,47),HX_("fromColorJson",61,0a,bf,95)));
            		}
            		_hx_goto_2:;
