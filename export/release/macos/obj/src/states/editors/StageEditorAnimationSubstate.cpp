...
void StageEditorAnimationSubstate_obj::reloadAnimList(){
            	HX_STACKFRAME(&_hx_pos_9b82f77f5e054157_2195_reloadAnimList)
...
HXDLIN(2200)			::Array< ::Dynamic> _g__groupMembers = this->animsTxtGroup->members;
HXDLIN(2200)			 ::Dynamic _g__filter = filter;
HXDLIN(2200)			int _g__cursor = 0;
HXDLIN(2200)			int _g__length = _g__groupMembers->length;
HXDLIN(2200)			while(true){
HXLINE(2200)				while(true){
HXLINE(2200)					bool _hx_tmp;
HXDLIN(2200)					if ((_g__cursor < _g__length)) {
HXLINE(2200)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::text::FlxText >() )) {
HXLINE(2200)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(2200)								_hx_tmp = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::text::FlxText >())) ));
            							}
            							else {
...
HXLINE(2200)						goto _hx_goto_16;
            					}
HXDLIN(2200)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_16:;
HXDLIN(2200)				if (!((_g__cursor < _g__length))) {
HXLINE(2200)					goto _hx_goto_15;
            				}
HXDLIN(2200)				 ::flixel::text::FlxText text;
HXDLIN(2200)				while(true){
HXLINE(2200)					bool text1;
HXDLIN(2200)					if ((_g__cursor < _g__length)) {
HXLINE(2200)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::text::FlxText >() )) {
HXLINE(2200)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(2200)								text1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::text::FlxText >())) ));
            							}
            							else {
HXLINE(2200)								text1 = false;
            							}
            						}
            						else {
HXLINE(2200)							text1 = true;
            						}
            					}
            					else {
HXLINE(2200)						text1 = false;
            					}
HXDLIN(2200)					if (!(text1)) {
HXLINE(2200)						goto _hx_goto_17;
            					}
HXDLIN(2200)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_17:;
HXDLIN(2200)				if ((_g__cursor < _g__length)) {
HXLINE(2200)					_g__cursor = (_g__cursor + 1);
HXDLIN(2200)					text = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::text::FlxText >();
            				}
            				else {
HXLINE(2200)					text = null();
            				}
HXDLIN(2200)				 ::flixel::text::FlxText text2 = text;
HXLINE(2201)				text2->kill();
            			}
            			_hx_goto_15:;
            		}
...
HXLINE(2206)			bool _hx_tmp1;
HXDLIN(2206)			if (::hx::IsNotNull( this->target->firstAnimation )) {
HXLINE(2206)				_hx_tmp1 = !(this->target->sprite->animation->exists(this->target->firstAnimation));
            			}
            			else {
...
HXLINE(2218)				{
HXLINE(2219)					 ::flixel::text::FlxText text3 = this->animsTxtGroup->recycle(::hx::ClassOf< ::flixel::text::FlxText >(),null(),null(),null()).StaticCast<  ::flixel::text::FlxText >();
HXLINE(2220)					text3->set_x(( (Float)(10) ));
HXLINE(2221)					text3->set_y(( (Float)((32 + (20 * num))) ));
HXLINE(2222)					text3->set_fieldWidth(( (Float)(400) ));
HXLINE(2223)					text3->set_fieldHeight(( (Float)(20) ));
HXLINE(2224)					if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE(2225)						::String _hx_tmp2 = ( (::String)(((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) + HX_(": ",a6,32,00,00))) );
HXDLIN(2225)						text3->set_text((_hx_tmp2 + ::Std_obj::string(spr->animOffsets->get( ::Dynamic(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))))));
            					}
            					else {
HXLINE(2227)						text3->set_text(( (::String)(((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) + HX_(": No offsets",e7,98,3c,0c))) ));
            					}
HXLINE(2229)					text3->setFormat(null(),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_FAST_dyn(),-16777216,null());
HXLINE(2230)					{
HXLINE(2230)						 ::flixel::math::FlxBasePoint this1 = text3->scrollFactor;
HXDLIN(2230)						this1->set_x(( (Float)(0) ));
HXDLIN(2230)						this1->set_y(( (Float)(0) ));
            					}
HXLINE(2231)					text3->set_borderSize(( (Float)(1) ));
HXLINE(2232)					this->animsTxtGroup->add(text3).StaticCast<  ::flixel::text::FlxText >();
            				}
            			}
            		}
HXLINE(2234)		{
...
HXDLIN(2234)				 ::flixel::text::FlxText text4 = _g_value1;
HXDLIN(2234)				{
HXLINE(2234)					text4->set_color(-1);
HXDLIN(2234)					if ((num1 == this->curAnim)) {
HXLINE(2234)						text4->set_color(-16711936);
            					}
            				}
            			}
            		}
...
HXDLIN(2340)				if (((_this14->viewX - _this14->_prevViewX) == 0)) {
HXLINE(2340)					 ::flixel::input::mouse::FlxMouse _this15 = ::flixel::FlxG_obj::mouse;
HXDLIN(2340)					_hx_tmp5 = ((_this15->viewY - _this15->_prevViewY) != 0);
            				}
            				else {
...
HXDLIN(2342)					spr->offset->set_x((spr->offset->x - ( (Float)((_this16->viewX - _this16->_prevViewX)) )));
            				}
HXLINE(2343)				{
HXLINE(2343)					 ::flixel::input::mouse::FlxMouse _this17 = ::flixel::FlxG_obj::mouse;
HXDLIN(2343)					spr->offset->set_y((spr->offset->y - ( (Float)((_this17->viewY - _this17->_prevViewY)) )));
            				}
