...
HXLINE( 509)				offsets = ( (::Array< Float >)(( ( ::haxe::ds::StringMap)( ::Dynamic(this->config->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic))) )->get(this->curAnim)->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) );
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 509)					offsets = ::Array_obj< Float >::fromData( _hx_array_data_8c409617_46,2);
            				}
            				else {
...
HXLINE( 554)							conf1->__SetField(HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_8c409617_48,2),::hx::paccDynamic);
...
HXDLIN( 628)			::Array< ::Dynamic> _g__groupMembers = this->strums->group->members;
HXDLIN( 628)			 ::Dynamic _g__filter = filter;
HXDLIN( 628)			int _g__cursor = 0;
HXDLIN( 628)			int _g__length = _g__groupMembers->length;
HXDLIN( 628)			while(true){
HXLINE( 628)				while(true){
HXLINE( 628)					bool _hx_tmp29;
HXDLIN( 628)					if ((_g__cursor < _g__length)) {
HXLINE( 628)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >() )) {
HXLINE( 628)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 628)								_hx_tmp29 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >())) ));
            							}
            							else {
HXLINE( 628)								_hx_tmp29 = false;
            							}
            						}
            						else {
HXLINE( 628)							_hx_tmp29 = true;
            						}
            					}
            					else {
HXLINE( 628)						_hx_tmp29 = false;
            					}
HXDLIN( 628)					if (!(_hx_tmp29)) {
HXLINE( 628)						goto _hx_goto_43;
            					}
HXDLIN( 628)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_43:;
HXDLIN( 628)				if (!((_g__cursor < _g__length))) {
HXLINE( 628)					goto _hx_goto_42;
            				}
HXDLIN( 628)				 ::objects::StrumNote strum;
HXDLIN( 628)				while(true){
HXLINE( 628)					bool strum1;
HXDLIN( 628)					if ((_g__cursor < _g__length)) {
HXLINE( 628)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >() )) {
HXLINE( 628)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 628)								strum1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >())) ));
            							}
            							else {
HXLINE( 628)								strum1 = false;
            							}
            						}
            						else {
HXLINE( 628)							strum1 = true;
            						}
            					}
            					else {
HXLINE( 628)						strum1 = false;
            					}
HXDLIN( 628)					if (!(strum1)) {
HXLINE( 628)						goto _hx_goto_44;
            					}
HXDLIN( 628)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_44:;
HXDLIN( 628)				if ((_g__cursor < _g__length)) {
HXLINE( 628)					_g__cursor = (_g__cursor + 1);
HXDLIN( 628)					strum = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::objects::StrumNote >();
            				}
            				else {
HXLINE( 628)					strum = null();
            				}
HXDLIN( 628)				 ::objects::StrumNote strum2 = strum;
HXLINE( 629)				strum2->playAnim(HX_("static",ae,dc,fb,05),null());
            			}
            			_hx_goto_42:;
            		}
            	}
...
HXLINE( 659)		this->redShader = ::Array_obj< int >::fromData( _hx_array_data_8c409617_52,3);
HXLINE( 660)		this->greenShader = ::Array_obj< int >::fromData( _hx_array_data_8c409617_53,3);
HXLINE( 661)		this->blueShader = ::Array_obj< int >::fromData( _hx_array_data_8c409617_54,3);
            	}
...
HXLINE( 745)		::flixel::FlxG_obj::log->advanced(HX_("Successfully saved file.",c0,0d,09,f4),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,false,::hx::SourceInfo(HX_("source/states/editors/NoteSplashEditorState.hx",95,5b,8e,7d),745,HX_("states.editors.NoteSplashEditorState",17,96,40,8c),HX_("onSaveComplete",d5,ac,3f,bc)));
            	}
...
HXLINE( 768)		::flixel::FlxG_obj::log->advanced(HX_("Problem saving file",41,4c,cd,8e),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("source/states/editors/NoteSplashEditorState.hx",95,5b,8e,7d),768,HX_("states.editors.NoteSplashEditorState",17,96,40,8c),HX_("onSaveError",2c,b6,19,24)));
            	}
...
HXLINE( 792)		this->_file->browse(::Array_obj< ::Dynamic>::__new(0));
            	}
...
HXLINE( 858)		::flixel::FlxG_obj::sound->muteKeys = ::Array_obj< int >::fromData( _hx_array_data_8c409617_67,1);
HXLINE( 859)		::flixel::FlxG_obj::sound->volumeDownKeys = ::Array_obj< int >::fromData( _hx_array_data_8c409617_68,2);
HXLINE( 860)		::flixel::FlxG_obj::sound->volumeUpKeys = ::Array_obj< int >::fromData( _hx_array_data_8c409617_69,2);
            	}
