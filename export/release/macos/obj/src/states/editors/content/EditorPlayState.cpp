...
HXDLIN( 527)			::Array< ::Dynamic> _g__groupMembers = this->comboGroup->group->members;
HXDLIN( 527)			 ::Dynamic _g__filter = filter;
HXDLIN( 527)			int _g__cursor = 0;
HXDLIN( 527)			int _g__length = _g__groupMembers->length;
HXDLIN( 527)			while(true){
HXLINE( 527)				while(true){
HXLINE( 527)					bool _hx_tmp1;
HXDLIN( 527)					if ((_g__cursor < _g__length)) {
HXLINE( 527)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 527)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 527)								_hx_tmp1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
...
HXLINE( 527)						goto _hx_goto_29;
            					}
HXDLIN( 527)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_29:;
HXDLIN( 527)				if (!((_g__cursor < _g__length))) {
HXLINE( 527)					goto _hx_goto_28;
            				}
HXDLIN( 527)				 ::flixel::FlxSprite spr;
HXDLIN( 527)				while(true){
HXLINE( 527)					bool spr1;
HXDLIN( 527)					if ((_g__cursor < _g__length)) {
HXLINE( 527)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 527)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 527)								spr1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
HXLINE( 527)								spr1 = false;
            							}
            						}
            						else {
HXLINE( 527)							spr1 = true;
            						}
            					}
            					else {
HXLINE( 527)						spr1 = false;
...
HXDLIN( 527)					if (!(spr1)) {
HXLINE( 527)						goto _hx_goto_30;
            					}
HXDLIN( 527)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_30:;
HXDLIN( 527)				if ((_g__cursor < _g__length)) {
HXLINE( 527)					_g__cursor = (_g__cursor + 1);
HXDLIN( 527)					spr = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::FlxSprite >();
            				}
            				else {
HXLINE( 527)					spr = null();
            				}
HXDLIN( 527)				 ::flixel::FlxSprite spr2 = spr;
HXLINE( 529)				if (::hx::IsNull( spr2 )) {
HXLINE( 529)					continue;
            				}
HXLINE( 531)				this->comboGroup->remove(spr2,null()).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 532)				spr2->destroy();
            			}
            			_hx_goto_28:;
            		}
...
HXLINE( 548)			_hx_tmp2 = !(( (bool)(note->noteSplashData->__Field(HX_("disabled",7c,41,04,7c),::hx::paccDynamic)) ));
            		}
            		else {
...
HXLINE( 563)				_hx_tmp3 = (axes == 17);
            			}
            			else {
HXLINE( 563)				_hx_tmp3 = true;
            			}
HXDLIN( 563)			if (_hx_tmp3) {
HXLINE( 563)				 ::flixel::FlxSprite rating2 = rating;
HXDLIN( 563)				int _hx_tmp4 = ::flixel::FlxG_obj::width;
HXDLIN( 563)				rating2->set_x(((( (Float)(_hx_tmp4) ) - rating->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 563)			bool _hx_tmp5;
HXDLIN( 563)			if ((axes != 16)) {
HXLINE( 563)				_hx_tmp5 = (axes == 17);
            			}
            			else {
HXLINE( 563)				_hx_tmp5 = true;
            			}
HXDLIN( 563)			if (_hx_tmp5) {
HXLINE( 563)				 ::flixel::FlxSprite rating3 = rating;
HXDLIN( 563)				int _hx_tmp6 = ::flixel::FlxG_obj::height;
HXDLIN( 563)				rating3->set_y(((( (Float)(_hx_tmp6) ) - rating->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 569)		bool _hx_tmp7;
HXDLIN( 569)		if (!(::backend::ClientPrefs_obj::data->hideHud)) {
HXLINE( 569)			_hx_tmp7 = this->showRating;
            		}
            		else {
HXLINE( 569)			_hx_tmp7 = false;
            		}
HXDLIN( 569)		rating->set_visible(_hx_tmp7);
...
HXLINE( 575)				_hx_tmp8 = (axes1 == 17);
            			}
            			else {
HXLINE( 575)				_hx_tmp8 = true;
            			}
HXDLIN( 575)			if (_hx_tmp8) {
HXLINE( 575)				 ::flixel::FlxSprite comboSpr2 = comboSpr1;
HXDLIN( 575)				int _hx_tmp9 = ::flixel::FlxG_obj::width;
HXDLIN( 575)				comboSpr2->set_x(((( (Float)(_hx_tmp9) ) - comboSpr1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 575)			bool _hx_tmp10;
HXDLIN( 575)			if ((axes1 != 16)) {
HXLINE( 575)				_hx_tmp10 = (axes1 == 17);
            			}
            			else {
HXLINE( 575)				_hx_tmp10 = true;
            			}
HXDLIN( 575)			if (_hx_tmp10) {
HXLINE( 575)				 ::flixel::FlxSprite comboSpr3 = comboSpr1;
HXDLIN( 575)				int _hx_tmp11 = ::flixel::FlxG_obj::height;
HXDLIN( 575)				comboSpr3->set_y(((( (Float)(_hx_tmp11) ) - comboSpr1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 579)		bool _hx_tmp12;
HXDLIN( 579)		if (!(::backend::ClientPrefs_obj::data->hideHud)) {
HXLINE( 579)			_hx_tmp12 = this->showCombo;
            		}
            		else {
HXLINE( 579)			_hx_tmp12 = false;
            		}
HXDLIN( 579)		comboSpr1->set_visible(_hx_tmp12);
...
HXDLIN( 594)			Float _hx_tmp13 = rating->get_width();
HXDLIN( 594)			rating7->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp13 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.85))),null());
HXLINE( 595)			 ::flixel::FlxSprite comboSpr7 = comboSpr1;
HXDLIN( 595)			Float _hx_tmp14 = comboSpr1->get_width();
HXDLIN( 595)			comboSpr7->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp14 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.85))),null());
            		}
...
HXDLIN( 610)					bool _hx_tmp15;
HXDLIN( 610)					if ((axes2 != 1)) {
HXLINE( 610)						_hx_tmp15 = (axes2 == 17);
            					}
            					else {
HXLINE( 610)						_hx_tmp15 = true;
            					}
HXDLIN( 610)					if (_hx_tmp15) {
HXLINE( 610)						 ::flixel::FlxSprite numScore3 = numScore2;
HXDLIN( 610)						int _hx_tmp16 = ::flixel::FlxG_obj::width;
HXDLIN( 610)						numScore3->set_x(((( (Float)(_hx_tmp16) ) - numScore2->get_width()) / ( (Float)(2) )));
            					}
HXDLIN( 610)					bool _hx_tmp17;
HXDLIN( 610)					if ((axes2 != 16)) {
HXLINE( 610)						_hx_tmp17 = (axes2 == 17);
            					}
            					else {
HXLINE( 610)						_hx_tmp17 = true;
            					}
HXDLIN( 610)					if (_hx_tmp17) {
HXLINE( 610)						 ::flixel::FlxSprite numScore4 = numScore2;
HXDLIN( 610)						int _hx_tmp18 = ::flixel::FlxG_obj::height;
HXDLIN( 610)						numScore4->set_y(((( (Float)(_hx_tmp18) ) - numScore2->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXDLIN( 615)					Float _hx_tmp19 = numScore2->get_width();
HXDLIN( 615)					numScore6->setGraphicSize(::Std_obj::_hx_int((_hx_tmp19 * ::states::PlayState_obj::daPixelZoom)),null());
            				}
...
void EditorPlayState_obj::keysCheck(){
            	HX_STACKFRAME(&_hx_pos_94828a72d2e97540_742_keysCheck)
...
HXDLIN( 762)			::Array< ::Dynamic> _g__groupMembers = this->notes->members;
HXDLIN( 762)			 ::Dynamic _g__filter = filter;
HXDLIN( 762)			int _g__cursor = 0;
HXDLIN( 762)			int _g__length = _g__groupMembers->length;
HXDLIN( 762)			while(true){
HXLINE( 762)				while(true){
HXLINE( 762)					bool _hx_tmp1;
HXDLIN( 762)					if ((_g__cursor < _g__length)) {
HXLINE( 762)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >() )) {
HXLINE( 762)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 762)								_hx_tmp1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >())) ));
            							}
            							else {
...
HXLINE( 762)						goto _hx_goto_43;
            					}
HXDLIN( 762)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_43:;
HXDLIN( 762)				if (!((_g__cursor < _g__length))) {
HXLINE( 762)					goto _hx_goto_42;
            				}
HXDLIN( 762)				 ::objects::Note n;
HXDLIN( 762)				while(true){
HXLINE( 762)					bool n1;
HXDLIN( 762)					if ((_g__cursor < _g__length)) {
HXLINE( 762)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >() )) {
HXLINE( 762)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 762)								n1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >())) ));
            							}
            							else {
HXLINE( 762)								n1 = false;
            							}
...
HXDLIN( 762)					if (!(n1)) {
HXLINE( 762)						goto _hx_goto_44;
            					}
HXDLIN( 762)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_44:;
HXDLIN( 762)				if ((_g__cursor < _g__length)) {
HXLINE( 762)					_g__cursor = (_g__cursor + 1);
HXDLIN( 762)					n = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::objects::Note >();
            				}
            				else {
HXLINE( 762)					n = null();
            				}
HXDLIN( 762)				 ::objects::Note n2 = n;
HXLINE( 763)				bool canHit;
HXDLIN( 763)				bool canHit1;
HXDLIN( 763)				bool canHit2;
HXDLIN( 763)				bool canHit3;
HXDLIN( 763)				bool canHit4;
HXDLIN( 763)				if (::hx::IsNotNull( n2 )) {
HXLINE( 763)					canHit4 = n2->canBeHit;
            				}
            				else {
HXLINE( 763)					canHit4 = false;
            				}
HXDLIN( 763)				if (canHit4) {
HXLINE( 763)					canHit3 = n2->mustPress;
            				}
            				else {
HXLINE( 763)					canHit3 = false;
            				}
HXDLIN( 763)				if (canHit3) {
HXLINE( 763)					canHit2 = !(n2->tooLate);
            				}
            				else {
HXLINE( 763)					canHit2 = false;
            				}
HXDLIN( 763)				if (canHit2) {
HXLINE( 763)					canHit1 = !(n2->wasGoodHit);
            				}
            				else {
HXLINE( 763)					canHit1 = false;
            				}
HXDLIN( 763)				if (canHit1) {
HXLINE( 763)					canHit = !(n2->blockHit);
            				}
            				else {
...
HXLINE( 767)						canHit5 = ::hx::IsNotNull( n2->parent );
            					}
            					else {
HXLINE( 767)						canHit5 = false;
            					}
HXDLIN( 767)					if (canHit5) {
HXLINE( 767)						canHit = n2->parent->wasGoodHit;
            					}
            					else {
...
HXLINE( 769)					_hx_tmp2 = n2->isSustainNote;
            				}
            				else {
HXLINE( 769)					_hx_tmp2 = false;
            				}
HXDLIN( 769)				if (_hx_tmp2) {
HXLINE( 770)					bool released = !(holdArray->__get(n2->noteData));
HXLINE( 772)					if (!(released)) {
HXLINE( 773)						this->goodNoteHit(n2);
            					}
            				}
            			}
            			_hx_goto_42:;
...
HXLINE( 779)			_hx_tmp3 = releaseArray->contains(true);
            		}
            		else {
