...
HXLINE( 156)			_gthis->fileDialog->open(null(),HX_("Load a .PNG/.OGG File...",ce,62,23,59),::Array_obj< ::Dynamic>::__new(0), ::Dynamic(new _hx_Closure_3(addToList,_gthis)),null(),null());
            		}
            		HX_END_LOCAL_FUNC0((void))
