...
HXLINE( 627)		this->_file->browse(::Array_obj< ::Dynamic>::__new(0));
            	}
...
HXLINE( 715)		::flixel::FlxG_obj::log->advanced(HX_("Successfully saved file.",c0,0d,09,f4),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,false,::hx::SourceInfo(HX_("source/states/editors/DialogueCharacterEditorState.hx",09,65,04,ac),715,HX_("states.editors.DialogueCharacterEditorState",47,eb,03,b3),HX_("onSaveComplete",d5,ac,3f,bc)));
            	}
...
HXLINE( 738)		::flixel::FlxG_obj::log->advanced(HX_("Problem saving file",41,4c,cd,8e),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("source/states/editors/DialogueCharacterEditorState.hx",09,65,04,ac),738,HX_("states.editors.DialogueCharacterEditorState",47,eb,03,b3),HX_("onSaveError",2c,b6,19,24)));
            	}
