...
HXLINE( 727)			::flixel::FlxG_obj::camera->followLerp = (((Float)0.04) * ( (Float)(_gthis->stageJson->__Field(HX_("camera_speed",2d,2f,ab,11),::hx::paccDynamic)) ));
            		}
            		HX_END_LOCAL_FUNC0((void))
...
HXLINE( 729)		::flixel::FlxG_obj::camera->followLerp = (((Float)0.04) * this->cameraSpeedStepper->value);
...
HXLINE(1174)		::flixel::FlxG_obj::camera->followLerp = (((Float)0.04) * this->cameraSpeedStepper->value);
...
HXDLIN(1446)			if (((_this24->viewX - _this24->_prevViewX) == 0)) {
HXLINE(1446)				 ::flixel::input::mouse::FlxMouse _this25 = ::flixel::FlxG_obj::mouse;
HXDLIN(1446)				_hx_tmp10 = ((_this25->viewY - _this25->_prevViewY) != 0);
            			}
            			else {
...
HXDLIN(1448)			moveX = (moveX + (( (Float)((_this26->viewX - _this26->_prevViewX)) ) * ctrlMult1));
HXLINE(1449)			 ::flixel::input::mouse::FlxMouse _this27 = ::flixel::FlxG_obj::mouse;
HXDLIN(1449)			moveY = (moveY + (( (Float)((_this27->viewY - _this27->_prevViewY)) ) * ctrlMult1));
...
HXLINE(1626)		::flixel::FlxG_obj::log->advanced(HX_("Successfully saved file.",c0,0d,09,f4),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,false,::hx::SourceInfo(HX_("source/states/editors/StageEditorState.hx",16,7c,21,9d),1626,HX_("states.editors.StageEditorState",1a,37,b1,81),HX_("onSaveComplete",d5,ac,3f,bc)));
            	}
...
HXLINE(1651)		::flixel::FlxG_obj::log->advanced(HX_("Problem saving file",41,4c,cd,8e),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("source/states/editors/StageEditorState.hx",16,7c,21,9d),1651,HX_("states.editors.StageEditorState",1a,37,b1,81),HX_("onSaveError",2c,b6,19,24)));
            	}
...
HXLINE(1664)		 ::openfl::net::FileFilter filters_0 =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("PNG (Image)",1f,c0,f5,35),HX_("*.png",65,8a,91,4d),null());
HXDLIN(1664)		 ::openfl::net::FileFilter filters_1 =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("XML (Sparrow)",3c,63,88,76),HX_("*.xml",93,9b,97,4d),null());
HXDLIN(1664)		 ::openfl::net::FileFilter filters_2 =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("JSON (Aseprite)",f4,90,6b,3f),HX_("*.json",ec,18,d4,8d),null());
HXDLIN(1664)		 ::openfl::net::FileFilter filters_3 =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("TXT (Packer)",6b,86,c8,54),HX_("*.txt",2c,9c,94,4d),null());
HXLINE(1665)		this->_file->browse(::Array_obj< ::Dynamic>::__new(0));
            	}
