...
HXDLIN(  39)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(400,-2050);
HXDLIN(  39)			point->_inPool = false;
HXDLIN(  39)			 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN(  39)			{
HXLINE(  39)				 ::flixel::math::FlxBasePoint this1 = _this->scroll;
HXDLIN(  39)				Float y = (point1->y - (( (Float)(_this->height) ) * ((Float)0.5)));
HXDLIN(  39)				this1->set_x((point1->x - (( (Float)(_this->width) ) * ((Float)0.5))));
HXDLIN(  39)				this1->set_y(y);
            			}
HXDLIN(  39)			{
HXLINE(  39)				 ::flixel::math::FlxBasePoint _this1 = point1;
