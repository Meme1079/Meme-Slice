...
HXDLIN(  96)			::Array< ::Dynamic> _g__groupMembers = ( ( ::flixel::group::FlxTypedSpriteGroup)(::flixel::FlxG_obj::game->_state->__Field(HX_("gfGroup",a0,b8,ab,b0),::hx::paccDynamic)) )->group->members;
HXDLIN(  96)			 ::Dynamic _g__filter = filter;
HXDLIN(  96)			int _g__cursor = 0;
HXDLIN(  96)			int _g__length = _g__groupMembers->length;
HXDLIN(  96)			while(true){
HXLINE(  96)				while(true){
HXLINE(  96)					bool _hx_tmp;
HXDLIN(  96)					if ((_g__cursor < _g__length)) {
HXLINE(  96)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE(  96)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(  96)								_hx_tmp = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
...
HXLINE(  96)						goto _hx_goto_13;
            					}
HXDLIN(  96)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_13:;
HXDLIN(  96)				if (!((_g__cursor < _g__length))) {
HXLINE(  96)					goto _hx_goto_12;
            				}
HXDLIN(  96)				 ::flixel::FlxSprite daGf;
HXDLIN(  96)				while(true){
HXLINE(  96)					bool daGf1;
HXDLIN(  96)					if ((_g__cursor < _g__length)) {
HXLINE(  96)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE(  96)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(  96)								daGf1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
HXLINE(  96)								daGf1 = false;
            							}
            						}
            						else {
HXLINE(  96)							daGf1 = true;
            						}
            					}
            					else {
HXLINE(  96)						daGf1 = false;
...
HXDLIN(  96)					_g__cursor = (_g__cursor + 1);
            				...
            				_hx_goto_14:;
HXDLIN(  96)				if ((_g__cursor < _g__length)) {
HXLINE(  96)					_g__cursor = (_g__cursor + 1);
HXDLIN(  96)					daGf = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::FlxSprite >();
            				}
            				else {
HXLINE(  96)					daGf = null();
            				}
HXDLIN(  96)				 ::flixel::FlxSprite daGf2 = daGf;
HXLINE(  98)				 ::objects::Character gf = ( ( ::objects::Character)(daGf2) );
...
HXLINE( 112)								int _hx_tmp1 = (200 + ::flixel::FlxG_obj::random->_hx_int(50,100,null()));
HXDLIN( 112)								tankBih->resetShit(( (Float)(500) ),( (Float)(_hx_tmp1) ),::hx::IsLess( ::states::stages::objects::TankmenBG_obj::animationNotes->__get(i)->__GetItem(1),2 ));
