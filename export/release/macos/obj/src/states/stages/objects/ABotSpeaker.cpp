...
HX_LOCAL_STACK_FRAME(_hx_pos_cb82bdab7b5f4ce1_90_update,"states.stages.objects.ABotSpeaker","update",0xbe77d785,"states.stages.objects.ABotSpeaker.update","states/stages/objects/ABotSpeaker.hx",90,0xa981e86d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cb82bdab7b5f4ce1_122_initAnalyzer,"states.stages.objects.ABotSpeaker","initAnalyzer",0x3f33c552,"states.stages.objects.ABotSpeaker.initAnalyzer","states/stages/objects/ABotSpeaker.hx",122,0xa981e86d)
...
void ABotSpeaker_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_cb82bdab7b5f4ce1_90_update)
HXLINE(  91)		this->super::update(elapsed);
HXLINE(  92)		if (::hx::IsNull( this->analyzer )) {
HXLINE(  92)			return;
            		}
HXLINE(  94)		this->levels = this->analyzer->getLevels(this->levels);
HXLINE(  95)		int oldLevelMax = this->levelMax;
HXLINE(  96)		this->levelMax = 0;
HXLINE(  97)		{
HXLINE(  97)			int _g = 0;
HXDLIN(  97)			int _g1 = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->vizSprites->length) ),( (Float)(this->levels->length) )));
HXDLIN(  97)			while((_g < _g1)){
HXLINE(  97)				_g = (_g + 1);
HXDLIN(  97)				int i = (_g - 1);
HXLINE(  99)				int animFrame = ::Math_obj::round((( (Float)(this->levels->__get(i)->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) ) * ( (Float)(5) )));
HXLINE( 100)				Float lowerBound;
HXDLIN( 100)				if ((animFrame < 0)) {
HXLINE( 100)					lowerBound = ( (Float)(0) );
            				}
            				else {
HXLINE( 100)					lowerBound = ( (Float)(animFrame) );
            				}
HXDLIN( 100)				Float animFrame1;
HXDLIN( 100)				if ((lowerBound > 5)) {
HXLINE( 100)					animFrame1 = ( (Float)(5) );
            				}
            				else {
HXLINE( 100)					animFrame1 = lowerBound;
            				}
HXDLIN( 100)				animFrame = ::Std_obj::_hx_int(::Math_obj::abs((animFrame1 - ( (Float)(5) ))));
HXLINE( 102)				this->vizSprites->__get(i).StaticCast<  ::flixel::FlxSprite >()->animation->_curAnim->set_curFrame(animFrame);
HXLINE( 103)				this->levelMax = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->levelMax) ),( (Float)((5 - animFrame)) )));
            			}
            		}
HXLINE( 106)		if ((this->levelMax >= 4)) {
HXLINE( 109)			bool _hx_tmp;
HXDLIN( 109)			if ((oldLevelMax <= this->levelMax)) {
HXLINE( 109)				if ((this->levelMax < 5)) {
HXLINE( 109)					_hx_tmp = (this->speaker->anim->get_curFrame() >= 3);
            				}
            				else {
...
void ABotSpeaker_obj::initAnalyzer(){
            	HX_GC_STACKFRAME(&_hx_pos_cb82bdab7b5f4ce1_122_initAnalyzer)
HXLINE( 124)		this->analyzer =  ::funkin::vis::dsp::SpectralAnalyzer_obj::__alloc( HX_CTX ,this->snd->_channel->_hx___audioSource,7,((Float)0.1),40);
HXLINE( 129)		this->analyzer->set_fftN(256);
            	}
...
::hx::Val ABotSpeaker_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"analyzer") ) { analyzer=inValue.Cast<  ::funkin::vis::dsp::SpectralAnalyzer >(); return inValue; }
