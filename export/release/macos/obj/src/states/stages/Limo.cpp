...
HXLINE( 267)				::flixel::FlxG_obj::log->advanced((HX_("Henchmen kills: ",1b,81,91,7c) + kills),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,false,::hx::SourceInfo(HX_("source/states/stages/Limo.hx",7e,07,dd,04),267,HX_("states.stages.Limo",2c,e5,4d,91),HX_("killHenchmen",de,fd,a5,32)));
            			}
            		}
            	}
