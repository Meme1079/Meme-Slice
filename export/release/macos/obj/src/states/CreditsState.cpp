...
static const ::String _hx_array_data_79985863_11[] = {
	HX_("Meme-Slice",b5,5d,1b,e2),
};
static const ::String _hx_array_data_79985863_12[] = {
	HX_("Meme1079",91,29,0b,79),HX_("meme1079",71,6d,59,9f),HX_("Main Programmer of Meme-Slice",5b,95,3e,58),HX_("https://github.com/Meme1079",5b,c0,f9,50),HX_("501AD9",40,fa,ba,f4),
};
...
static const ::String _hx_array_data_79985863_45[] = {
	HX_("",00,00,00,00),
};
...
HXLINE(  40)		::Array< ::Dynamic> defaultList = ::Array_obj< ::Dynamic>::__new(31)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_79985863_7,1))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_79985863_8,5))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_79985863_9,5))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_79985863_10,1))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_79985863_11,1))->init(5,::Array_obj< ::String >::fromData( _hx_array_data_79985863_12,5))->init(6,::Array_obj< ::String >::fromData( _hx_array_data_79985863_13,1))->init(7,::Array_obj< ::String >::fromData( _hx_array_data_79985863_14,1))->init(8,::Array_obj< ::String >::fromData( _hx_array_data_79985863_15,5))->init(9,::Array_obj< ::String >::fromData( _hx_array_data_79985863_16,1))->init(10,::Array_obj< ::String >::fromData( _hx_array_data_79985863_17,1))->init(11,::Array_obj< ::String >::fromData( _hx_array_data_79985863_18,5))->init(12,::Array_obj< ::String >::fromData( _hx_array_data_79985863_19,5))->init(13,::Array_obj< ::String >::fromData( _hx_array_data_79985863_20,5))->init(14,::Array_obj< ::String >::fromData( _hx_array_data_79985863_21,5))->init(15,::Array_obj< ::String >::fromData( _hx_array_data_79985863_22,5))->init(16,::Array_obj< ::String >::fromData( _hx_array_data_79985863_23,5))->init(17,::Array_obj< ::String >::fromData( _hx_array_data_79985863_24,5))->init(18,::Array_obj< ::String >::fromData( _hx_array_data_79985863_25,5))->init(19,::Array_obj< ::String >::fromData( _hx_array_data_79985863_26,5))->init(20,::Array_obj< ::String >::fromData( _hx_array_data_79985863_27,5))->init(21,::Array_obj< ::String >::fromData( _hx_array_data_79985863_28,5))->init(22,::Array_obj< ::String >::fromData( _hx_array_data_79985863_29,1))->init(23,::Array_obj< ::String >::fromData( _hx_array_data_79985863_30,1))->init(24,::Array_obj< ::String >::fromData( _hx_array_data_79985863_31,5))->init(25,::Array_obj< ::String >::fromData( _hx_array_data_79985863_32,5))->init(26,::Array_obj< ::String >::fromData( _hx_array_data_79985863_33,5))->init(27,::Array_obj< ::String >::fromData( _hx_array_data_79985863_34,5))->init(28,::Array_obj< ::String >::fromData( _hx_array_data_79985863_35,1))->init(29,::Array_obj< ::String >::fromData( _hx_array_data_79985863_36,1))->init(30,::Array_obj< ::String >::fromData( _hx_array_data_79985863_37,5));
HXLINE(  74)		{
HXLINE(  74)			int _g7 = 0;
...
HXLINE( 185)				::backend::MusicBeatState_obj::switchState( ::states::MainMenuState_obj::__alloc( HX_CTX ));
...
HXLINE( 274)			this->creditsStuff->push(::Array_obj< ::String >::fromData( _hx_array_data_79985863_45,1));
            		}
            	}
