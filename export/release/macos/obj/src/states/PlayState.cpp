...
HXLINE( 924)			::flixel::FlxG_obj::log->advanced(HX_("Your dialogue file is badly formatted!",40,79,c5,b3),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("source/states/PlayState.hx",3a,21,29,28),924,HX_("states.PlayState",31,cd,20,04),HX_("startDialogue",9a,8f,4f,ac)));
...
HXLINE(1676)			::flixel::FlxG_obj::camera->followLerp = ((((Float)0.04) * this->cameraSpeed) * this->playbackRate);
...
HXLINE(1687)			::flixel::FlxG_obj::camera->followLerp = ( (Float)(0) );
            		}
...
HXLINE(1913)		::flixel::FlxG_obj::camera->followLerp = ( (Float)(0) );
...
HXDLIN(1925)			::Array< ::Dynamic> _g__groupMembers = this->playerStrums->members;
HXDLIN(1925)			 ::Dynamic _g__filter = filter;
HXDLIN(1925)			int _g__cursor = 0;
HXDLIN(1925)			int _g__length = _g__groupMembers->length;
HXDLIN(1925)			while(true){
HXLINE(1925)				while(true){
HXLINE(1925)					bool _hx_tmp;
HXDLIN(1925)					if ((_g__cursor < _g__length)) {
HXLINE(1925)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >() )) {
HXLINE(1925)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(1925)								_hx_tmp = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >())) ));
            							}
            							else {
...
HXLINE(1925)						goto _hx_goto_128;
            					}
HXDLIN(1925)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_128:;
HXDLIN(1925)				if (!((_g__cursor < _g__length))) {
HXLINE(1925)					goto _hx_goto_127;
            				}
HXDLIN(1925)				 ::objects::StrumNote note;
HXDLIN(1925)				while(true){
HXLINE(1925)					bool note1;
HXDLIN(1925)					if ((_g__cursor < _g__length)) {
HXLINE(1925)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >() )) {
HXLINE(1925)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(1925)								note1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::StrumNote >())) ));
            							}
            							else {
HXLINE(1925)								note1 = false;
            							}
            						}
            						else {
HXLINE(1925)							note1 = true;
            						}
            					}
            					else {
HXLINE(1925)						note1 = false;
            					}
HXDLIN(1925)					if (!(note1)) {
HXLINE(1925)						goto _hx_goto_129;
            					}
HXDLIN(1925)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_129:;
HXDLIN(1925)				if ((_g__cursor < _g__length)) {
HXLINE(1925)					_g__cursor = (_g__cursor + 1);
HXDLIN(1925)					note = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::objects::StrumNote >();
            				}
            				else {
HXLINE(1925)					note = null();
            				}
HXDLIN(1925)				 ::objects::StrumNote note2 = note;
HXLINE(1926)				bool _hx_tmp1;
HXDLIN(1926)				if (::hx::IsNotNull( note2->animation->_curAnim )) {
HXLINE(1926)					_hx_tmp1 = (note2->animation->_curAnim->name != HX_("static",ae,dc,fb,05));
            				}
            				else {
HXLINE(1926)					_hx_tmp1 = false;
            				}
HXDLIN(1926)				if (_hx_tmp1) {
HXLINE(1928)					note2->playAnim(HX_("static",ae,dc,fb,05),null());
HXLINE(1929)					note2->resetAnim = ( (Float)(0) );
            				}
            			}
            			_hx_goto_127:;
            		}
...
HXLINE(1935)			::String _hx_tmp2 = this->detailsPausedText;
HXDLIN(1935)			::String _hx_tmp3 = ( (::String)((((::states::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic) + HX_(" (",08,1c,00,00)) + this->storyDifficultyText) + HX_(")",29,00,00,00))) );
HXDLIN(1935)			::backend::DiscordClient_obj::changePresence(_hx_tmp2,_hx_tmp3,this->iconP2->getCharacter(),null(),null(),null());
            		}
            	}
...
HXLINE(1942)		::flixel::FlxG_obj::camera->followLerp = ( (Float)(0) );
...
HXLINE(1965)		::flixel::FlxG_obj::camera->followLerp = ( (Float)(0) );
...
HXLINE(2007)				::flixel::FlxG_obj::camera->filters = ::Array_obj< ::Dynamic>::__new(0);
...
HXDLIN(2151)				goto _hx_goto_138;
            			}
            			if (  (_hx_switch_1==HX_("gf",1f,5a,00,00)) ||  (_hx_switch_1==HX_("girlfriend",ba,91,48,98)) ){
HXLINE(2149)				_hx_char = this->gf;
HXDLIN(2149)				goto _hx_goto_138;
            			}
            			/* default */{
...
HXLINE(2431)		this->checkForAchievement(::Array_obj< ::String >::__new(7)->init(0,weekNoMiss)->init(1,HX_("ur_bad",a3,4f,85,aa))->init(2,HX_("ur_good",9f,19,79,8d))->init(3,HX_("hype",46,63,1a,45))->init(4,HX_("two_keys",c7,f4,0a,9b))->init(5,HX_("toastie",43,0c,91,5f))->init(6,HX_("debugger",21,24,eb,90)));
...
HXDLIN(2555)			::Array< ::Dynamic> _g__groupMembers = this->comboGroup->group->members;
HXDLIN(2555)			 ::Dynamic _g__filter = filter;
HXDLIN(2555)			int _g__cursor = 0;
HXDLIN(2555)			int _g__length = _g__groupMembers->length;
HXDLIN(2555)			while(true){
HXLINE(2555)				while(true){
HXLINE(2555)					bool _hx_tmp1;
HXDLIN(2555)					if ((_g__cursor < _g__length)) {
HXLINE(2555)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE(2555)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(2555)								_hx_tmp1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
...
HXLINE(2555)						goto _hx_goto_162;
            					}
HXDLIN(2555)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_162:;
HXDLIN(2555)				if (!((_g__cursor < _g__length))) {
HXLINE(2555)					goto _hx_goto_161;
            				}
HXDLIN(2555)				 ::flixel::FlxSprite spr;
HXDLIN(2555)				while(true){
HXLINE(2555)					bool spr1;
HXDLIN(2555)					if ((_g__cursor < _g__length)) {
HXLINE(2555)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE(2555)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(2555)								spr1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
HXLINE(2555)								spr1 = false;
            							}
            						}
            						else {
HXLINE(2555)							spr1 = true;
            						}
            					}
            					else {
HXLINE(2555)						spr1 = false;
...
HXDLIN(2555)					if (!(spr1)) {
HXLINE(2555)						goto _hx_goto_163;
            					}
HXDLIN(2555)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_163:;
HXDLIN(2555)				if ((_g__cursor < _g__length)) {
HXLINE(2555)					_g__cursor = (_g__cursor + 1);
HXDLIN(2555)					spr = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::FlxSprite >();
            				}
            				else {
HXLINE(2555)					spr = null();
            				}
HXDLIN(2555)				 ::flixel::FlxSprite spr2 = spr;
HXLINE(2557)				if (::hx::IsNull( spr2 )) {
HXLINE(2557)					continue;
            				}
HXLINE(2559)				this->comboGroup->remove(spr2,null()).StaticCast<  ::flixel::FlxSprite >();
HXLINE(2560)				spr2->destroy();
            			}
            			_hx_goto_161:;
            		}
...
HXLINE(2571)		 ::states::PlayState _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2571)		_hx_tmp2->totalNotesHit = (_hx_tmp2->totalNotesHit + daRating->ratingMod);
...
HXLINE(2577)		bool _hx_tmp3;
HXDLIN(2577)		if (daRating->noteSplash) {
HXLINE(2577)			_hx_tmp3 = !(( (bool)(note->noteSplashData->__Field(HX_("disabled",7c,41,04,7c),::hx::paccDynamic)) ));
            		}
            		else {
HXLINE(2577)			_hx_tmp3 = false;
            		}
HXDLIN(2577)		if (_hx_tmp3) {
HXLINE(2578)			this->spawnNoteSplashOnNote(note);
            		}
HXLINE(2580)		if (!(this->cpuControlled)) {
HXLINE(2581)			 ::states::PlayState _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2581)			_hx_tmp4->songScore = (_hx_tmp4->songScore + score);
...
HXDLIN(2599)			bool _hx_tmp5;
HXDLIN(2599)			if ((axes != 1)) {
HXLINE(2599)				_hx_tmp5 = (axes == 17);
            			}
            			else {
HXLINE(2599)				_hx_tmp5 = true;
            			}
HXDLIN(2599)			if (_hx_tmp5) {
HXLINE(2599)				 ::flixel::FlxSprite rating2 = rating;
HXDLIN(2599)				int _hx_tmp6 = ::flixel::FlxG_obj::width;
HXDLIN(2599)				rating2->set_x(((( (Float)(_hx_tmp6) ) - rating->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(2599)			bool _hx_tmp7;
HXDLIN(2599)			if ((axes != 16)) {
HXLINE(2599)				_hx_tmp7 = (axes == 17);
            			}
            			else {
HXLINE(2599)				_hx_tmp7 = true;
            			}
HXDLIN(2599)			if (_hx_tmp7) {
HXLINE(2599)				 ::flixel::FlxSprite rating3 = rating;
HXDLIN(2599)				int _hx_tmp8 = ::flixel::FlxG_obj::height;
HXDLIN(2599)				rating3->set_y(((( (Float)(_hx_tmp8) ) - rating->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(2605)		bool _hx_tmp9;
HXDLIN(2605)		if (!(::backend::ClientPrefs_obj::data->hideHud)) {
HXLINE(2605)			_hx_tmp9 = this->showRating;
            		}
            		else {
HXLINE(2605)			_hx_tmp9 = false;
            		}
HXDLIN(2605)		rating->set_visible(_hx_tmp9);
...
HXDLIN(2611)			bool _hx_tmp10;
HXDLIN(2611)			if ((axes1 != 1)) {
HXLINE(2611)				_hx_tmp10 = (axes1 == 17);
            			}
            			else {
HXLINE(2611)				_hx_tmp10 = true;
            			}
HXDLIN(2611)			if (_hx_tmp10) {
HXLINE(2611)				 ::flixel::FlxSprite comboSpr2 = comboSpr1;
HXDLIN(2611)				int _hx_tmp11 = ::flixel::FlxG_obj::width;
HXDLIN(2611)				comboSpr2->set_x(((( (Float)(_hx_tmp11) ) - comboSpr1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(2611)			bool _hx_tmp12;
HXDLIN(2611)			if ((axes1 != 16)) {
HXLINE(2611)				_hx_tmp12 = (axes1 == 17);
            			}
            			else {
HXLINE(2611)				_hx_tmp12 = true;
            			}
HXDLIN(2611)			if (_hx_tmp12) {
HXLINE(2611)				 ::flixel::FlxSprite comboSpr3 = comboSpr1;
HXDLIN(2611)				int _hx_tmp13 = ::flixel::FlxG_obj::height;
HXDLIN(2611)				comboSpr3->set_y(((( (Float)(_hx_tmp13) ) - comboSpr1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(2615)		bool _hx_tmp14;
HXDLIN(2615)		if (!(::backend::ClientPrefs_obj::data->hideHud)) {
HXLINE(2615)			_hx_tmp14 = this->showCombo;
            		}
            		else {
HXLINE(2615)			_hx_tmp14 = false;
            		}
HXDLIN(2615)		comboSpr1->set_visible(_hx_tmp14);
...
HXDLIN(2630)			Float _hx_tmp15 = rating->get_width();
HXDLIN(2630)			rating7->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp15 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.85))),null());
HXLINE(2631)			 ::flixel::FlxSprite comboSpr7 = comboSpr1;
HXDLIN(2631)			Float _hx_tmp16 = comboSpr1->get_width();
HXDLIN(2631)			comboSpr7->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp16 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.85))),null());
            		}
...
HXDLIN(2646)					bool _hx_tmp17;
HXDLIN(2646)					if ((axes2 != 1)) {
HXLINE(2646)						_hx_tmp17 = (axes2 == 17);
            					}
            					else {
HXLINE(2646)						_hx_tmp17 = true;
            					}
HXDLIN(2646)					if (_hx_tmp17) {
HXLINE(2646)						 ::flixel::FlxSprite numScore3 = numScore2;
HXDLIN(2646)						int _hx_tmp18 = ::flixel::FlxG_obj::width;
HXDLIN(2646)						numScore3->set_x(((( (Float)(_hx_tmp18) ) - numScore2->get_width()) / ( (Float)(2) )));
            					}
HXDLIN(2646)					bool _hx_tmp19;
HXDLIN(2646)					if ((axes2 != 16)) {
HXLINE(2646)						_hx_tmp19 = (axes2 == 17);
            					}
            					else {
HXLINE(2646)						_hx_tmp19 = true;
            					}
HXDLIN(2646)					if (_hx_tmp19) {
HXLINE(2646)						 ::flixel::FlxSprite numScore4 = numScore2;
HXDLIN(2646)						int _hx_tmp20 = ::flixel::FlxG_obj::height;
HXDLIN(2646)						numScore4->set_y(((( (Float)(_hx_tmp20) ) - numScore2->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXDLIN(2651)					Float _hx_tmp21 = numScore2->get_width();
HXDLIN(2651)					numScore6->setGraphicSize(::Std_obj::_hx_int((_hx_tmp21 * ::states::PlayState_obj::daPixelZoom)),null());
            				}
...
void PlayState_obj::keysCheck(){
            	HX_STACKFRAME(&_hx_pos_801e532e222627de_2819_keysCheck)
...
HXDLIN(2840)				::Array< ::Dynamic> _g__groupMembers = this->notes->members;
HXDLIN(2840)				 ::Dynamic _g__filter = filter;
HXDLIN(2840)				int _g__cursor = 0;
HXDLIN(2840)				int _g__length = _g__groupMembers->length;
HXDLIN(2840)				while(true){
HXLINE(2840)					while(true){
HXLINE(2840)						bool _hx_tmp5;
HXDLIN(2840)						if ((_g__cursor < _g__length)) {
HXLINE(2840)							if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >() )) {
HXLINE(2840)								if (::hx::IsNotNull( _g__filter )) {
HXLINE(2840)									_hx_tmp5 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >())) ));
            								}
            								else {
HXLINE(2840)									_hx_tmp5 = false;
            								}
            							}
            							else {
...
HXLINE(2840)							goto _hx_goto_176;
            						}
HXDLIN(2840)						_g__cursor = (_g__cursor + 1);
            					}
            					_hx_goto_176:;
HXDLIN(2840)					if (!((_g__cursor < _g__length))) {
HXLINE(2840)						goto _hx_goto_175;
            					}
HXDLIN(2840)					 ::objects::Note n;
HXDLIN(2840)					while(true){
HXLINE(2840)						bool n1;
HXDLIN(2840)						if ((_g__cursor < _g__length)) {
HXLINE(2840)							if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >() )) {
HXLINE(2840)								if (::hx::IsNotNull( _g__filter )) {
HXLINE(2840)									n1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::objects::Note >())) ));
            								}
            								else {
HXLINE(2840)									n1 = false;
            								}
            							}
            							else {
HXLINE(2840)								n1 = true;
...
HXDLIN(2840)						if (!(n1)) {
HXLINE(2840)							goto _hx_goto_177;
            						}
HXDLIN(2840)						_g__cursor = (_g__cursor + 1);
            					}
            					_hx_goto_177:;
HXDLIN(2840)					if ((_g__cursor < _g__length)) {
HXLINE(2840)						_g__cursor = (_g__cursor + 1);
HXDLIN(2840)						n = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::objects::Note >();
            					}
            					else {
HXLINE(2840)						n = null();
            					}
HXDLIN(2840)					 ::objects::Note n2 = n;
...
HXDLIN(2841)					if (::hx::IsNotNull( n2 )) {
HXLINE(2841)						canHit5 = !(this->strumsBlocked->__get(n2->noteData));
            					}
            					else {
HXLINE(2841)						canHit5 = false;
            					}
HXDLIN(2841)					if (canHit5) {
HXLINE(2841)						canHit4 = n2->canBeHit;
            					}
            					else {
HXLINE(2841)						canHit4 = false;
            					}
HXDLIN(2841)					if (canHit4) {
HXLINE(2841)						canHit3 = n2->mustPress;
            					}
            					else {
HXLINE(2841)						canHit3 = false;
            					}
HXDLIN(2841)					if (canHit3) {
HXLINE(2841)						canHit2 = !(n2->tooLate);
            					}
            					else {
HXLINE(2841)						canHit2 = false;
            					}
HXDLIN(2841)					if (canHit2) {
HXLINE(2841)						canHit1 = !(n2->wasGoodHit);
            					}
            					else {
HXLINE(2841)						canHit1 = false;
            					}
HXDLIN(2841)					if (canHit1) {
HXLINE(2841)						canHit = !(n2->blockHit);
            					}
            					else {
...
HXLINE(2845)							canHit6 = ::hx::IsNotNull( n2->parent );
            						}
            						else {
HXLINE(2845)							canHit6 = false;
            						}
HXDLIN(2845)						if (canHit6) {
HXLINE(2845)							canHit = n2->parent->wasGoodHit;
            						}
            						else {
HXLINE(2845)							canHit = false;
            						}
            					}
HXLINE(2847)					bool _hx_tmp6;
HXDLIN(2847)					if (canHit) {
HXLINE(2847)						_hx_tmp6 = n2->isSustainNote;
            					}
            					else {
HXLINE(2847)						_hx_tmp6 = false;
            					}
HXDLIN(2847)					if (_hx_tmp6) {
HXLINE(2848)						bool released = !(holdArray->__get(n2->noteData));
HXLINE(2850)						if (!(released)) {
HXLINE(2851)							this->goodNoteHit(n2);
            						}
            					}
            				}
            				_hx_goto_175:;
...
HXLINE(2856)				_hx_tmp7 = this->endingSong;
            			}
            			else {
...
HXLINE(2860)				this->checkForAchievement(::Array_obj< ::String >::fromData( _hx_array_data_0420cd31_180,1));
            			}
            		}
HXLINE(2865)		bool _hx_tmp8;
HXDLIN(2865)		bool _hx_tmp9;
HXDLIN(2865)		if (!(this->get_controls()->controllerMode)) {
HXLINE(2865)			_hx_tmp9 = this->strumsBlocked->contains(true);
            		}
            		else {
HXLINE(2865)			_hx_tmp9 = true;
            		}
HXDLIN(2865)		if (_hx_tmp9) {
HXLINE(2865)			_hx_tmp8 = releaseArray->contains(true);
            		}
            		else {
HXLINE(2865)			_hx_tmp8 = false;
            		}
...
HXLINE(2867)				bool _hx_tmp10;
HXDLIN(2867)				if (!(releaseArray->__get(i1))) {
HXLINE(2867)					_hx_tmp10 = (this->strumsBlocked->__get(i1) == true);
            				}
            				else {
HXLINE(2867)					_hx_tmp10 = true;
            				}
HXDLIN(2867)				if (_hx_tmp10) {
...
HXLINE(3186)		::flixel::FlxG_obj::camera->filters = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE(3560)						if ((this->songName == HX_("test",52,c8,f9,4c))) {
HXLINE(3560)							unlock = !(usedPractice);
            						}
            						else {
HXLINE(3560)							unlock = false;
            						}
HXDLIN(3560)						goto _hx_goto_225;
            					}
...
HXLINE(3586)			::flixel::FlxG_obj::log->advanced(((HX_("Shader ",3b,a9,d7,2c) + shaderName) + HX_(" is missing!",d1,64,6b,b3)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("source/states/PlayState.hx",3a,21,29,28),3586,HX_("states.PlayState",31,cd,20,04),HX_("createRuntimeShader",81,55,08,17)));
...
HXLINE(3605)			::flixel::FlxG_obj::log->advanced(((HX_("Shader ",3b,a9,d7,2c) + name) + HX_(" was already initialized!",8c,8e,cf,cf)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("source/states/PlayState.hx",3a,21,29,28),3605,HX_("states.PlayState",31,cd,20,04),HX_("initLuaShader",cd,69,3d,b0)));
