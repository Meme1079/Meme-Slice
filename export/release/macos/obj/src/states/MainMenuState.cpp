...
HXDLIN( 161)				if (((_this->viewX - _this->_prevViewX) != 0)) {
HXLINE( 161)					 ::flixel::input::mouse::FlxMouse _this1 = ::flixel::FlxG_obj::mouse;
HXDLIN( 161)					_hx_tmp1 = ((_this1->viewY - _this1->_prevViewY) != 0);
            				}
            				else {
...
HXLINE( 323)							::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,url),HX_("_blank",95,26,d9,b0));
            						}
...
HXDLIN( 333)					::Array< ::Dynamic> _g__groupMembers = this->menuItems->members;
HXDLIN( 333)					 ::Dynamic _g__filter = filter;
HXDLIN( 333)					int _g__cursor = 0;
HXDLIN( 333)					int _g__length = _g__groupMembers->length;
HXDLIN( 333)					while(true){
HXLINE( 333)						while(true){
HXLINE( 333)							bool _hx_tmp12;
HXDLIN( 333)							if ((_g__cursor < _g__length)) {
HXLINE( 333)								if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 333)									if (::hx::IsNotNull( _g__filter )) {
HXLINE( 333)										_hx_tmp12 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            									}
            									else {
...
HXLINE( 333)								goto _hx_goto_11;
            							}
HXDLIN( 333)							_g__cursor = (_g__cursor + 1);
            						}
            						_hx_goto_11:;
HXDLIN( 333)						if (!((_g__cursor < _g__length))) {
HXLINE( 333)							goto _hx_goto_10;
            						}
HXDLIN( 333)						 ::flixel::FlxSprite memb1;
HXDLIN( 333)						while(true){
HXLINE( 333)							bool memb2;
HXDLIN( 333)							if ((_g__cursor < _g__length)) {
HXLINE( 333)								if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 333)									if (::hx::IsNotNull( _g__filter )) {
HXLINE( 333)										memb2 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            									}
            									else {
HXLINE( 333)										memb2 = false;
            									}
            								}
            								else {
HXLINE( 333)									memb2 = true;
            								}
            							}
            							else {
HXLINE( 333)								memb2 = false;
...
HXDLIN( 333)							_g__cursor = (_g__cursor + 1);
            						...
            						_hx_goto_12:;
HXDLIN( 333)						if ((_g__cursor < _g__length)) {
HXLINE( 333)							_g__cursor = (_g__cursor + 1);
HXDLIN( 333)							memb1 = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::FlxSprite >();
            						}
            						else {
HXLINE( 333)							memb1 = null();
            						}
HXDLIN( 333)						 ::flixel::FlxSprite memb3 = memb1;
HXLINE( 335)						if (::hx::IsInstanceEq( memb3,item->__get(0).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 336)							continue;
            						}
HXLINE( 338)						::flixel::tweens::FlxTween_obj::tween(memb3, ::Dynamic(::hx::Anon_obj::Create(1)
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_89e648ab22b7047a_355_changeItem)
...
HXDLIN( 360)			::Array< ::Dynamic> _g__groupMembers = this->menuItems->members;
HXDLIN( 360)			 ::Dynamic _g__filter = filter;
HXDLIN( 360)			int _g__cursor = 0;
HXDLIN( 360)			int _g__length = _g__groupMembers->length;
HXDLIN( 360)			while(true){
HXLINE( 360)				while(true){
HXLINE( 360)					bool _hx_tmp1;
HXDLIN( 360)					if ((_g__cursor < _g__length)) {
HXLINE( 360)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 360)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 360)								_hx_tmp1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
...
HXLINE( 360)						goto _hx_goto_16;
            					}
HXDLIN( 360)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_16:;
HXDLIN( 360)				if (!((_g__cursor < _g__length))) {
HXLINE( 360)					goto _hx_goto_15;
            				}
HXDLIN( 360)				 ::flixel::FlxSprite item;
HXDLIN( 360)				while(true){
HXLINE( 360)					bool item1;
HXDLIN( 360)					if ((_g__cursor < _g__length)) {
HXLINE( 360)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 360)							if (::hx::IsNotNull( _g__filter )) {
HXLINE( 360)								item1 = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxSprite >())) ));
            							}
            							else {
HXLINE( 360)								item1 = false;
            							}
            						}
            						else {
HXLINE( 360)							item1 = true;
            						}
            					}
            					else {
HXLINE( 360)						item1 = false;
...
HXDLIN( 360)					if (!(item1)) {
HXLINE( 360)						goto _hx_goto_17;
            					}
HXDLIN( 360)					_g__cursor = (_g__cursor + 1);
            				}
            				_hx_goto_17:;
HXDLIN( 360)				if ((_g__cursor < _g__length)) {
HXLINE( 360)					_g__cursor = (_g__cursor + 1);
HXDLIN( 360)					item = _g__groupMembers->__get((_g__cursor - 1)).StaticCast<  ::flixel::FlxSprite >();
            				}
            				else {
HXLINE( 360)					item = null();
            				}
HXDLIN( 360)				 ::flixel::FlxSprite item2 = item;
HXLINE( 362)				item2->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 363)				item2->centerOffsets(null());
            			}
            			_hx_goto_15:;
            		}
...
HXLINE( 378)		 ::flixel::FlxObject _hx_tmp2 = this->camFollow;
HXDLIN( 378)		_hx_tmp2->set_y(selectedItem->getGraphicMidpoint(null())->y);
            	}
