...
HXLINE(3693)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3695)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3642)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3644)					bool _hx_tmp1;
HXDLIN(3644)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3644)						_hx_tmp1 = !(this->get_displayAsPassword());
            					}
            					else {
...
HXDLIN(3687)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3653)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3655)					bool _hx_tmp2;
HXDLIN(3655)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3655)						_hx_tmp2 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3655)						_hx_tmp2 = false;
            					}
HXDLIN(3655)					if (_hx_tmp2) {
...
HXLINE(3660)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3520)				bool _hx_tmp3;
HXDLIN(3520)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3520)					_hx_tmp3 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3520)					_hx_tmp3 = false;
            				}
HXDLIN(3520)				if (_hx_tmp3) {
...
HXLINE(3607)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3624)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3556)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3539)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3573)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3590)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
