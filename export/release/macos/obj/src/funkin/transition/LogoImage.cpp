...
HX_DEFINE_STACK_FRAME(_hx_pos_333e49fea58a2ac6_47_new,"funkin.transition.LogoImage","new",0x38ee4006,"funkin.transition.LogoImage.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_6192e3df25e24444_24_boot,"funkin.transition.LogoImage","boot",0x8fa2c5cc,"funkin.transition.LogoImage.boot","funkin/transition/FunkinPreloader.hx",24,0x4960c7d5)
namespace funkin{
...
void LogoImage_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_333e49fea58a2ac6_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  73)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::funkin::transition::LogoImage_obj::resourceName));
HXLINE(  74)		{
...
bool LogoImage_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x073e5103) {
		...
		return inClassId==(int)0x2b62400a;
	}
}
...
::hx::ObjectPtr< LogoImage_obj > LogoImage_obj::__alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	LogoImage_obj *__this = (LogoImage_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(LogoImage_obj), true, "funkin.transition.LogoImage"));
...
void LogoImage_obj::__register()
{
	...
	__mClass->mName = HX_("funkin.transition.LogoImage",14,85,08,27);
...
{
{
            	HX_STACKFRAME(&_hx_pos_6192e3df25e24444_24_boot)
HXDLIN(  24)		resourceName = HX_("__ASSET__:bitmap_funkin_transition_LogoImage",ce,f0,6c,0b);
            	}
}
