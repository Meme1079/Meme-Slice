...
HX_LOCAL_STACK_FRAME(_hx_pos_a057a3e57c2eb2b2_102_showAnim,"funkin.ui.FunkinSoundTray","showAnim",0x72414525,"funkin.ui.FunkinSoundTray.showAnim","funkin/ui/FunkinSoundTray.hx",102,0xa75e31e7)
namespace funkin{
namespace ui{
...
HXLINE(  73)			if ((this->_timer > 0)) {
HXLINE(  74)				 ::funkin::ui::FunkinSoundTray _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  74)				_hx_tmp2->_timer = (_hx_tmp2->_timer - (ms / ( (Float)(1000) )));
            			}
            			else {
HXLINE(  75)				Float _hx_tmp3 = this->get_y();
HXDLIN(  75)				if ((_hx_tmp3 >= -(this->get_height()))) {
HXLINE(  76)					this->lerpYPos = (-(this->get_height()) - ( (Float)(10) ));
HXLINE(  77)					this->alphaTarget = ( (Float)(0) );
            				}
            			}
HXLINE(  80)			Float _hx_tmp4 = this->get_y();
HXDLIN(  80)			if ((_hx_tmp4 <= -(this->get_height()))) {
HXLINE(  81)				this->set_visible(false);
HXLINE(  82)				this->active = false;
HXLINE(  85)				 ::flixel::util::FlxSaveStatus _g = ::flixel::FlxG_obj::save->status;
HXDLIN(  85)				bool _hx_tmp5;
HXDLIN(  85)				if ((_g->_hx_getIndex() == 1)) {
HXLINE(  85)					::String _g1 = _g->_hx_getString(0);
HXDLIN(  85)					::String _g2 = _g->_hx_getString(1);
HXDLIN(  85)					_hx_tmp5 = true;
            				}
            				else {
HXLINE(  85)					_hx_tmp5 = false;
            				}
HXDLIN(  85)				if (_hx_tmp5) {
HXLINE(  86)					::flixel::FlxG_obj::save->data->__SetField(HX_("mute",d9,6e,65,48),::flixel::FlxG_obj::sound->muted,::hx::paccDynamic);
HXLINE(  87)					::flixel::FlxG_obj::save->data->__SetField(HX_("volume",da,29,53,5f),::flixel::FlxG_obj::sound->volume,::hx::paccDynamic);
HXLINE(  88)					::flixel::FlxG_obj::save->flush(null());
            				}
            			}
            		}
            	}
...
void FunkinSoundTray_obj::showAnim(Float volume, ::Dynamic sound,::hx::Null< Float >  __o_duration,::String __o_label){
            	...
            	HX_STACKFRAME(&_hx_pos_a057a3e57c2eb2b2_102_showAnim)
HXLINE( 103)		this->_timer = ( (Float)(1) );
HXLINE( 104)		this->lerpYPos = ( (Float)(10) );
HXLINE( 105)		this->set_visible(true);
HXLINE( 106)		this->active = true;
HXLINE( 107)		this->alphaTarget = ( (Float)(1) );
HXLINE( 109)		int globalVolume = ::Math_obj::round((( (Float)(::flixel::FlxG_obj::sound->applySoundCurve(::flixel::FlxG_obj::sound->volume)) ) * ( (Float)(10) )));
HXLINE( 110)		bool _hx_tmp;
HXDLIN( 110)		if (!(::flixel::FlxG_obj::sound->muted)) {
HXLINE( 110)			_hx_tmp = (::flixel::FlxG_obj::sound->volume == 0);
            		}
            		else {
HXLINE( 110)			_hx_tmp = true;
            		}
HXDLIN( 110)		if (_hx_tmp) {
HXLINE( 111)			globalVolume = 0;
            		}
HXLINE( 114)		if (::hx::IsNotNull( sound )) {
HXLINE( 115)			if ((globalVolume == 10)) {
HXLINE( 116)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 116)				 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN( 116)				::String id = this->volumeMaxSound;
HXDLIN( 116)				 ::flixel::_hx_system::debug::log::LogStyle logStyle = null();
HXDLIN( 116)				::String id1;
HXDLIN( 116)				bool id2;
HXDLIN( 116)				bool id3;
HXDLIN( 116)				if (!(::StringTools_obj::endsWith(id,HX_(".mp3",02,e8,ba,1e)))) {
HXLINE( 116)					id3 = !(::StringTools_obj::endsWith(id,HX_(".ogg",e1,64,bc,1e)));
            				}
            				else {
HXLINE( 116)					id3 = false;
            				}
HXDLIN( 116)				if (id3) {
HXLINE( 116)					id2 = !(::StringTools_obj::endsWith(id,HX_(".wav",be,71,c2,1e)));
            				}
            				else {
HXLINE( 116)					id2 = false;
            				}
HXDLIN( 116)				if (id2) {
HXLINE( 116)					id1 = (id + _this->defaultSoundExtension);
            				}
            				else {
HXLINE( 116)					id1 = id;
            				}
HXDLIN( 116)				_hx_tmp1->play(( ( ::openfl::media::Sound)(_this->getAsset(id1,HX_("sound",cf,8c,cc,80),true,logStyle)) ),null(),null(),null(),null(),null());
            			}
            			else {
HXLINE( 118)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 118)				 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this1 = ::flixel::FlxG_obj::assets;
HXDLIN( 118)				 ::flixel::_hx_system::debug::log::LogStyle logStyle1 = null();
HXDLIN( 118)				::String id4;
HXDLIN( 118)				bool id5;
HXDLIN( 118)				bool id6;
HXDLIN( 118)				if (!(::StringTools_obj::endsWith(( (::String)(sound) ),HX_(".mp3",02,e8,ba,1e)))) {
HXLINE( 118)					id6 = !(::StringTools_obj::endsWith(( (::String)(sound) ),HX_(".ogg",e1,64,bc,1e)));
            				}
            				else {
HXLINE( 118)					id6 = false;
            				}
HXDLIN( 118)				if (id6) {
HXLINE( 118)					id5 = !(::StringTools_obj::endsWith(( (::String)(sound) ),HX_(".wav",be,71,c2,1e)));
            				}
            				else {
HXLINE( 118)					id5 = false;
            				}
HXDLIN( 118)				if (id5) {
HXLINE( 118)					id4 = (sound + _this1->defaultSoundExtension);
            				}
            				else {
HXLINE( 118)					id4 = ( (::String)(sound) );
            				}
HXDLIN( 118)				_hx_tmp2->play(( ( ::openfl::media::Sound)(_this1->getAsset(id4,HX_("sound",cf,8c,cc,80),true,logStyle1)) ),null(),null(),null(),null(),null());
            			}
            		}
HXLINE( 122)		{
HXLINE( 122)			int _g = 0;
HXDLIN( 122)			int _g1 = this->_bars->length;
HXDLIN( 122)			while((_g < _g1)){
HXLINE( 122)				_g = (_g + 1);
HXDLIN( 122)				int i = (_g - 1);
HXLINE( 123)				if ((i < globalVolume)) {
HXLINE( 124)					this->_bars->__get(i).StaticCast<  ::openfl::display::Bitmap >()->set_visible(true);
            				}
            				else {
HXLINE( 126)					this->_bars->__get(i).StaticCast<  ::openfl::display::Bitmap >()->set_visible(false);
            				}
            			}
            		}
            	}
