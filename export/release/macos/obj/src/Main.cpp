...
HX_DEFINE_STACK_FRAME(_hx_pos_e47a9afac0942eb9_200_new,"Main","new",0x6616a5cb,"Main.new","Main.hx",200,0x087e5c05)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_214_resetSpriteCache,"Main","resetSpriteCache",0xd7fbf223,"Main.resetSpriteCache","Main.hx",214,0x087e5c05)
...
HXLINE( 149)				::states::PlayState_obj::instance->addTextToDebug((HX_("FATAL: ",8a,63,ea,e4) + msgInfo1),-4521984);
            		...
            		void _hx_run(int w,int h){
            			HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_200_new)
HXLINE( 201)			if (::hx::IsNotNull( ::flixel::FlxG_obj::cameras )) {
HXLINE( 202)				int _g = 0;
HXDLIN( 202)				::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::cameras->list;
HXDLIN( 202)				while((_g < _g1->length)){
HXLINE( 202)					 ::flixel::FlxCamera cam = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 202)					_g = (_g + 1);
HXLINE( 203)					bool _hx_tmp;
HXDLIN( 203)					if (::hx::IsNotNull( cam )) {
HXLINE( 203)						_hx_tmp = ::hx::IsNotNull( cam->filters );
            					}
            					else {
HXLINE( 203)						_hx_tmp = false;
            					}
HXDLIN( 203)					if (_hx_tmp) {
HXLINE( 204)						::Main_obj::resetSpriteCache(cam->flashSprite);
            					}
            				}
            			}
HXLINE( 208)			if (::hx::IsNotNull( ::flixel::FlxG_obj::game )) {
HXLINE( 209)				::Main_obj::resetSpriteCache(::flixel::FlxG_obj::game);
            			}
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXDLIN(  93)		_hx_tmp1->bind(HX_("funkin",31,b2,4f,6f),(((HX_("",00,00,00,00) + company) + HX_("/",2f,00,00,00)) + ::flixel::util::FlxSave_obj::validate(::openfl::Lib_obj::get_current()->stage->application->meta->get_string(HX_("file",7c,ce,bb,43)))),null());
...
HXLINE( 158)		int game = ( (int)(::Main_obj::game->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) );
HXDLIN( 158)		int game1 = ( (int)(::Main_obj::game->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) );
HXDLIN( 158)		 ::flixel::FlxGame game2 =  ::flixel::FlxGame_obj::__alloc( HX_CTX ,game,game1,::flixel::util::typeLimit::_NextState::InitialState_Impl__obj::fromType(::Main_obj::game->__Field(HX_("initialState",ed,76,1b,48),::hx::paccDynamic)),::Main_obj::game->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic),::Main_obj::game->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic),::Main_obj::game->__Field(HX_("skipSplash",46,75,9c,27),::hx::paccDynamic),::Main_obj::game->__Field(HX_("startFullscreen",3d,c1,ee,2d),::hx::paccDynamic));
HXLINE( 164)		game2->_customSoundTray = ::hx::ClassOf< ::funkin::ui::FunkinSoundTray >();
HXLINE( 165)		this->addChild(game2);
HXLINE( 168)		::Main_obj::fpsVar =  ::debug::FPSCounter_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE( 169)		this->addChild(::Main_obj::fpsVar);
HXLINE( 170)		::openfl::Lib_obj::get_current()->stage->align = ::openfl::display::_StageAlign::StageAlign_Impl__obj::fromString(HX_("tl",78,65,00,00));
HXLINE( 171)		::openfl::Lib_obj::get_current()->stage->set_scaleMode(2);
HXLINE( 172)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE( 173)			::Main_obj::fpsVar->set_visible(::backend::ClientPrefs_obj::data->showFPS);
            		}
HXLINE( 178)		 ::lime::graphics::Image icon = ::lime::graphics::Image_obj::fromFile(HX_("icon.png",34,c5,eb,60));
HXLINE( 179)		::openfl::Lib_obj::get_current()->stage->window->setIcon(icon);
HXLINE( 187)		::flixel::FlxG_obj::fixedTimestep = false;
HXLINE( 188)		::flixel::FlxG_obj::game->focusLostFramerate = 60;
HXLINE( 189)		::flixel::FlxG_obj::keys->preventDefaultKeys = ::Array_obj< int >::fromData( _hx_array_data_332f6459_10,1);
HXLINE( 192)		::openfl::Lib_obj::get_current()->get_loaderInfo()->uncaughtErrorEvents->addEventListener(HX_("uncaughtError",f3,98,8b,8b),this->onCrash_dyn(),null(),null(),null());
HXLINE( 196)		::backend::DiscordClient_obj::prepare();
HXLINE( 200)		::flixel::FlxG_obj::signals->gameResized->add( ::Dynamic(new _hx_Closure_3()));
            	}
...
void Main_obj::onCrash( ::openfl::events::UncaughtErrorEvent e){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_224_onCrash)
...
HXLINE( 226)		::String path = (((HX_("./crash/",69,79,f9,62) + HX_("PsychEngine_",82,ba,54,e7)) + dateNow) + HX_(".txt",02,3f,c0,1e));
HXLINE( 235)		{
HXLINE( 235)			int _g = 0;
...
HXLINE( 239)					 ::haxe::StackItem s = stackItem->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 239)					::String file = stackItem->_hx_getString(1);
HXDLIN( 239)					int line = stackItem->_hx_getInt(2);
HXDLIN( 239)					 ::Dynamic column = stackItem->_hx_getObject(3);
...
HXLINE( 252)		errMsg = (errMsg + HX_("\n\n> Crash Handler written by: sqirra-rng",0b,0d,70,2d));
HXLINE( 254)		if (!(::sys::FileSystem_obj::exists(HX_("./crash/",69,79,f9,62)))) {
HXLINE( 255)			::sys::FileSystem_obj::createDirectory(HX_("./crash/",69,79,f9,62));
            		}
HXLINE( 257)		::sys::io::File_obj::saveContent(path,(errMsg + HX_("\n",0a,00,00,00)));
HXLINE( 259)		::Sys_obj::println(errMsg);
HXLINE( 260)		::Sys_obj::println((HX_("Crash dump saved in ",cf,9c,69,5d) + ::haxe::io::Path_obj::normalize(path)));
HXLINE( 262)		::lime::app::Application_obj::current->_hx___window->alert(errMsg,HX_("Error!",79,f7,fc,85));
HXLINE( 264)		::backend::DiscordClient_obj::shutdown();
HXLINE( 266)		::Sys_obj::exit(1);
            	}
...
void Main_obj::resetSpriteCache( ::openfl::display::Sprite sprite){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_214_resetSpriteCache)
HXLINE( 215)		sprite->_hx___cacheBitmap = null();
HXLINE( 216)		sprite->_hx___cacheBitmapData = null();
            	}
