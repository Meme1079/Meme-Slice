...
void SaveVariables_obj::__construct( ::Dynamic downScroll, ::Dynamic middleScroll, ::Dynamic opponentStrums, ::Dynamic showFPS, ::Dynamic flashing, ::Dynamic autoPause, ::Dynamic antialiasing,::String noteSkin,::String splashSkin,::String holdCoverSkin, ::Dynamic splashAlpha, ::Dynamic holdCoverAlpha, ::Dynamic lowQuality, ::Dynamic shaders, ::Dynamic cacheOnGPU, ::Dynamic framerate, ::Dynamic camZooms, ::Dynamic hideHud, ::Dynamic noteOffset,::Array< ::Dynamic> arrowRGB,::Array< ::Dynamic> arrowRGBPixel, ::Dynamic ghostTapping,::String timeBarType, ::Dynamic scoreZoom, ::Dynamic noReset, ::Dynamic healthBarAlpha, ::Dynamic hitsoundVolume,::String pauseMusic, ::Dynamic checkForUpdates, ::Dynamic comboStacking, ::haxe::ds::StringMap gameplaySettings,::Array< int > comboOffset, ::Dynamic ratingOffset, ::Dynamic sickWindow, ::Dynamic goodWindow, ::Dynamic badWindow, ::Dynamic safeFrames, ::Dynamic guitarHeroSustains, ::Dynamic discordRPC, ::Dynamic loadingScreen,::String language){
            	HX_GC_STACKFRAME(&_hx_pos_c0fe648b9977b22a_10_new)
HXLINE(  81)		this->language = HX_("en-US",02,7f,50,70);
HXLINE(  80)		this->loadingScreen = true;
HXLINE(  79)		this->discordRPC = true;
HXLINE(  78)		this->guitarHeroSustains = true;
HXLINE(  77)		this->safeFrames = ((Float)10.0);
HXLINE(  76)		this->badWindow = ((Float)135.0);
HXLINE(  75)		this->goodWindow = ((Float)90.0);
HXLINE(  74)		this->sickWindow = ((Float)45.0);
HXLINE(  73)		this->ratingOffset = 0;
HXLINE(  72)		this->comboOffset = ::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_1,4);
HXLINE(  50)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(  50)		_g->set(HX_("scrollspeed",5a,70,19,38),((Float)1.0));
HXDLIN(  50)		_g->set(HX_("scrolltype",47,55,ef,1f),HX_("multiplicative",96,7a,3f,fa));
HXDLIN(  50)		_g->set(HX_("songspeed",92,6f,b6,1d),((Float)1.0));
HXDLIN(  50)		_g->set(HX_("healthgain",1b,97,1b,16),((Float)1.0));
HXDLIN(  50)		_g->set(HX_("healthloss",7f,50,74,19),((Float)1.0));
HXDLIN(  50)		_g->set(HX_("instakill",f9,72,23,49),false);
HXDLIN(  50)		_g->set(HX_("practice",bb,00,e7,a0),false);
HXDLIN(  50)		_g->set(HX_("botplay",7b,fb,a9,61),false);
HXDLIN(  50)		_g->set(HX_("opponentplay",11,7a,4c,86),false);
HXDLIN(  50)		this->gameplaySettings = _g;
HXLINE(  49)		this->comboStacking = true;
HXLINE(  48)		this->checkForUpdates = true;
HXLINE(  47)		this->pauseMusic = HX_("Tea Time",9d,d4,cb,99);
HXLINE(  46)		this->hitsoundVolume = ((Float)0);
HXLINE(  45)		this->healthBarAlpha = ((Float)1);
HXLINE(  44)		this->noReset = false;
HXLINE(  43)		this->scoreZoom = true;
HXLINE(  42)		this->timeBarType = HX_("Time Left",fa,08,f2,62);
HXLINE(  41)		this->ghostTapping = true;
HXLINE(  35)		this->arrowRGBPixel = ::Array_obj< ::Dynamic>::__new(4)->init(0,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_2,3))->init(1,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_3,3))->init(2,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_4,3))->init(3,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_5,3));
HXLINE(  30)		this->arrowRGB = ::Array_obj< ::Dynamic>::__new(4)->init(0,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_6,3))->init(1,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_7,3))->init(2,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_8,3))->init(3,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_9,3));
HXLINE(  29)		this->noteOffset = 0;
HXLINE(  28)		this->hideHud = false;
HXLINE(  27)		this->camZooms = true;
HXLINE(  26)		this->framerate = 60;
HXLINE(  25)		this->cacheOnGPU = false;
HXLINE(  24)		this->shaders = true;
HXLINE(  23)		this->lowQuality = false;
HXLINE(  22)		this->holdCoverAlpha = ((Float)1);
HXLINE(  21)		this->splashAlpha = ((Float)0.6);
HXLINE(  20)		this->holdCoverSkin = HX_("Default",a1,00,15,69);
...
HXDLIN(  10)		if (::hx::IsNotNull( holdCoverSkin )) {
HXDLIN(  10)			this->holdCoverSkin = holdCoverSkin;
            		}
HXDLIN(  10)		if (::hx::IsNotNull( splashAlpha )) {
HXDLIN(  10)			this->splashAlpha = ( (Float)(splashAlpha) );
            		}
HXDLIN(  10)		if (::hx::IsNotNull( holdCoverAlpha )) {
HXDLIN(  10)			this->holdCoverAlpha = ( (Float)(holdCoverAlpha) );
            		}
...
Dynamic SaveVariables_obj::__Create(::hx::DynamicArray inArgs)
{
	...
	_hx_result->__construct(inArgs[0],inArgs[1],inArgs[2],inArgs[3],inArgs[4],inArgs[5],inArgs[6],inArgs[7],inArgs[8],inArgs[9],inArgs[10],inArgs[11],inArgs[12],inArgs[13],inArgs[14],inArgs[15],inArgs[16],inArgs[17],inArgs[18],inArgs[19],inArgs[20],inArgs[21],inArgs[22],inArgs[23],inArgs[24],inArgs[25],inArgs[26],inArgs[27],inArgs[28],inArgs[29],inArgs[30],inArgs[31],inArgs[32],inArgs[33],inArgs[34],inArgs[35],inArgs[36],inArgs[37],inArgs[38],inArgs[39],inArgs[40]);
	return _hx_result;
}
...
void SaveVariables_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(holdCoverSkin,"holdCoverSkin");
	HX_MARK_MEMBER_NAME(splashAlpha,"splashAlpha");
	HX_MARK_MEMBER_NAME(holdCoverAlpha,"holdCoverAlpha");
...
void SaveVariables_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(holdCoverSkin,"holdCoverSkin");
	HX_VISIT_MEMBER_NAME(splashAlpha,"splashAlpha");
	HX_VISIT_MEMBER_NAME(holdCoverAlpha,"holdCoverAlpha");
...
::hx::Val SaveVariables_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"holdCoverSkin") ) { return ::hx::Val( holdCoverSkin ); }
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"holdCoverAlpha") ) { return ::hx::Val( holdCoverAlpha ); }
...
::hx::Val SaveVariables_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"holdCoverSkin") ) { holdCoverSkin=inValue.Cast< ::String >(); return inValue; }
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"holdCoverAlpha") ) { holdCoverAlpha=inValue.Cast< Float >(); return inValue; }
...
void SaveVariables_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("holdCoverSkin",15,20,fa,bc));
	outFields->push(HX_("splashAlpha",77,20,7a,a6));
	outFields->push(HX_("holdCoverAlpha",c6,02,5a,41));
...
static ::hx::StorageInfo SaveVariables_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(SaveVariables_obj,holdCoverSkin),HX_("holdCoverSkin",15,20,fa,bc)},
	{::hx::fsFloat,(int)offsetof(SaveVariables_obj,splashAlpha),HX_("splashAlpha",77,20,7a,a6)},
	{::hx::fsFloat,(int)offsetof(SaveVariables_obj,holdCoverAlpha),HX_("holdCoverAlpha",c6,02,5a,41)},
...
static ::String SaveVariables_obj_sMemberFields[] = {
	...
	HX_("holdCoverSkin",15,20,fa,bc),
	HX_("splashAlpha",77,20,7a,a6),
	HX_("holdCoverAlpha",c6,02,5a,41),
