...
HX_DEFINE_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_47_new,"backend.Song","new",0x743f8f01,"backend.Song.new","backend/Song.hx",47,0x16217dae)
...
void Song_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_47_new)
...
HXLINE(  53)		this->needsVoices = true;
            	}
...
static ::hx::StorageInfo Song_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(Song_obj,holdCoverSkin),HX_("holdCoverSkin",15,20,fa,bc)},
