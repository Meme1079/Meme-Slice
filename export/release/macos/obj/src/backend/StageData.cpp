...
HXLINE( 211)						::flixel::FlxG_obj::log->advanced(err,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("source/backend/StageData.hx",e5,b2,1c,75),211,HX_("backend.StageData",0e,ab,06,d4),HX_("addObjectsToState",23,a2,67,39)));
            					}
            					_hx_goto_9:;
            				}
            			}
