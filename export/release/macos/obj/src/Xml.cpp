...
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_266_remove,"Xml","remove",0x890f021b,"Xml.remove","/usr/local/lib/haxe/std/Xml.hx",266,0x5c1024e4)
...
void Xml_obj::remove(::String att){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_266_remove)
