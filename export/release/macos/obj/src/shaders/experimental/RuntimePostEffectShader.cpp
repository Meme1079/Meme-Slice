...
HX_DEFINE_STACK_FRAME(_hx_pos_aa2e3282ffd1df4f_102_new,"shaders.experimental.RuntimePostEffectShader","new",0xafd84d5a,"shaders.experimental.RuntimePostEffectShader.new","shaders/experimental/RuntimePostEffectShader.hx",102,0x78d426b6)
HX_LOCAL_STACK_FRAME(_hx_pos_aa2e3282ffd1df4f_111_updateViewInfo,"shaders.experimental.RuntimePostEffectShader","updateViewInfo",0xdd0d31e2,"shaders.experimental.RuntimePostEffectShader.updateViewInfo","shaders/experimental/RuntimePostEffectShader.hx",111,0x78d426b6)
HX_LOCAL_STACK_FRAME(_hx_pos_aa2e3282ffd1df4f_118_updateFrameInfo,"shaders.experimental.RuntimePostEffectShader","updateFrameInfo",0xc30fd3ec,"shaders.experimental.RuntimePostEffectShader.updateFrameInfo","shaders/experimental/RuntimePostEffectShader.hx",118,0x78d426b6)
HX_LOCAL_STACK_FRAME(_hx_pos_aa2e3282ffd1df4f_123___createGLProgram,"shaders.experimental.RuntimePostEffectShader","__createGLProgram",0x6d53fbbd,"shaders.experimental.RuntimePostEffectShader.__createGLProgram","shaders/experimental/RuntimePostEffectShader.hx",123,0x78d426b6)
namespace shaders{
namespace experimental{

void RuntimePostEffectShader_obj::__construct(::String fragmentSource,::String vertexSource){
            	HX_STACKFRAME(&_hx_pos_aa2e3282ffd1df4f_102_new)
...
HXLINE( 103)		super::__construct(::openfl::utils::Assets_obj::getText(::backend::Paths_obj::getPath(HX_("shaders/rain.frag",ab,57,49,a1),null(),null(),true)),vertexSource);
HXLINE( 104)		this->setFloatArray(HX_("uScreenResolution",4d,4a,8e,f5),::Array_obj< Float >::__new(2)->init(0,::flixel::FlxG_obj::width)->init(1,::flixel::FlxG_obj::height));
HXLINE( 105)		this->setFloatArray(HX_("uCameraBounds",0f,f3,17,d8),::Array_obj< Float >::__new(4)->init(0,0)->init(1,0)->init(2,::flixel::FlxG_obj::width)->init(3,::flixel::FlxG_obj::height));
HXLINE( 106)		this->setFloatArray(HX_("uFrameBounds",0d,04,15,35),::Array_obj< Float >::__new(4)->init(0,0)->init(1,0)->init(2,::flixel::FlxG_obj::width)->init(3,::flixel::FlxG_obj::height));
...
void RuntimePostEffectShader_obj::updateViewInfo(Float screenWidth,Float screenHeight, ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_aa2e3282ffd1df4f_111_updateViewInfo)
HXLINE( 112)		this->setFloatArray(HX_("uScreenResolution",4d,4a,8e,f5),::Array_obj< Float >::__new(2)->init(0,screenWidth)->init(1,screenHeight));
HXLINE( 113)		this->setFloatArray(HX_("uCameraBounds",0f,f3,17,d8),::Array_obj< Float >::__new(4)->init(0,(camera->scroll->x + camera->viewMarginX))->init(1,(camera->scroll->y + camera->viewMarginY))->init(2,(camera->scroll->x + (( (Float)(camera->width) ) - camera->viewMarginX)))->init(3,(camera->scroll->y + (( (Float)(camera->height) ) - camera->viewMarginY))));
            	}
...
void RuntimePostEffectShader_obj::updateFrameInfo( ::flixel::graphics::frames::FlxFrame frame){
            	HX_STACKFRAME(&_hx_pos_aa2e3282ffd1df4f_118_updateFrameInfo)
HXDLIN( 118)		this->setFloatArray(HX_("uFrameBounds",0d,04,15,35),::Array_obj< Float >::__new(4)->init(0,frame->uv->x)->init(1,frame->uv->width)->init(2,frame->uv->y)->init(3,frame->uv->height));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(RuntimePostEffectShader_obj,updateFrameInfo,(void))
 ...
 ::lime::graphics::opengl::GLObject RuntimePostEffectShader_obj::_hx___createGLProgram(::String vertexSource,::String fragmentSource){
            	HX_STACKFRAME(&_hx_pos_aa2e3282ffd1df4f_123___createGLProgram)
HXDLIN( 123)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 125)			 ::lime::graphics::opengl::GLObject res = this->super::_hx___createGLProgram(vertexSource,fragmentSource);
HXLINE( 126)			return res;
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE( 128)				 ::haxe::Exception error = ::haxe::Exception_obj::caught(_g);
HXLINE( 130)				::lime::utils::Log_obj::warn(error,::hx::SourceInfo(HX_("source/shaders/experimental/RuntimePostEffectShader.hx",42,ba,1b,5c),130,HX_("shaders.experimental.RuntimePostEffectShader",68,58,64,6a),HX_("__createGLProgram",43,7d,b4,bf)));
...
::hx::ObjectPtr< RuntimePostEffectShader_obj > RuntimePostEffectShader_obj::__alloc(::hx::Ctx *_hx_ctx,::String fragmentSource,::String vertexSource) {
	RuntimePostEffectShader_obj *__this = (RuntimePostEffectShader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(RuntimePostEffectShader_obj), true, "shaders.experimental.RuntimePostEffectShader"));
...
void RuntimePostEffectShader_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(screenCoord,"screenCoord");
...
{
	HX_VISIT_MEMBER_NAME(screenCoord,"screenCoord");
...
::hx::Val RuntimePostEffectShader_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		if (HX_FIELD_EQ(inName,"screenCoord") ) { return ::hx::Val( screenCoord ); }
		break;
	case 12:
...
::hx::Val RuntimePostEffectShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 11:
		if (HX_FIELD_EQ(inName,"screenCoord") ) { screenCoord=inValue.Cast<  ::openfl::display::ShaderParameter_Float >(); return inValue; }
		break;
	case 12:
...
{
	outFields->push(HX_("screenCoord",a9,07,e4,01));
...
static ::hx::StorageInfo RuntimePostEffectShader_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(RuntimePostEffectShader_obj,screenCoord),HX_("screenCoord",a9,07,e4,01)},
...
void RuntimePostEffectShader_obj::__register()
{
	...
	__mClass->mName = HX_("shaders.experimental.RuntimePostEffectShader",68,58,64,6a);
