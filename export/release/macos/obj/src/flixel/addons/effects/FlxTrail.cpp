...
HXLINE( 167)			 ::flixel::math::FlxBasePoint this1 = list->pop().StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 167)			this1->set_x(x);
HXDLIN( 167)			this1->set_y(y);
HXLINE( 166)			pos = this1;
            		}
            		else {
...
HXLINE( 177)				 ::flixel::math::FlxBasePoint this1 = list->pop().StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 177)				this1->set_x(x);
HXDLIN( 177)				this1->set_y(y);
HXDLIN( 177)				pos = this1;
            			}
            			else {
...
HXLINE( 188)				 ::flixel::math::FlxBasePoint this2 = list1->pop().StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 188)				this2->set_x(x1);
HXDLIN( 188)				this2->set_y(y1);
HXDLIN( 188)				pos1 = this2;
            			}
            			else {
...
HXLINE( 220)				 ::flixel::math::FlxBasePoint this1 = trailSprite->scale;
HXDLIN( 220)				 ::flixel::math::FlxBasePoint p = this->_recentScales->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 220)				{
HXLINE( 220)					Float y = p->y;
HXDLIN( 220)					this1->set_x(p->x);
HXDLIN( 220)					this1->set_y(y);
            				}
HXDLIN( 220)				{
