...
HXLINE(  59)				{
HXLINE(  59)					 ::flixel::math::FlxBasePoint this1 = this->getScreenPosition(this->_point,camera);
HXDLIN(  59)					 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN(  59)					{
HXLINE(  59)						Float y = point->y;
HXDLIN(  59)						this1->set_x((this1->x - point->x));
HXDLIN(  59)						this1->set_y((this1->y - y));
            					}
HXDLIN(  59)					{
HXLINE(  59)						 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(  59)						if (_this->_weak) {
HXLINE(  59)							_this->put();
            						}
            					}
            				}
