...
HX_DEFINE_STACK_FRAME(_hx_pos_70f0cc6e85e841ba_572_new,"objects.PixelSplashShader","new",0xb8c8064a,"objects.PixelSplashShader.new","objects/NoteSplash.hx",572,0xe471e78a)
namespace objects{

void PixelSplashShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_70f0cc6e85e841ba_572_new)
...
HXLINE( 530)		this->_hx___isGenerated = true;
HXDLIN( 530)		this->_hx___initGL();
            	}
