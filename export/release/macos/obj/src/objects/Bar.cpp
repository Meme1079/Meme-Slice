...
HXLINE(  19)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(3,3);
HXDLIN(  19)		point->_inPool = false;
HXDLIN(  19)		this->barOffset = point;
