...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::backend::MusicBeatState_obj
{
	...
	public:
		...
		::Array< ::Dynamic> eventNotes;
		 ...
		 ::flixel::group::FlxTypedGroup grpNoteHoldCover;
		bool camZooming;
		...
		void spawnNoteHoldCoverOnNote( ::objects::Note note);
		::Dynamic spawnNoteHoldCoverOnNote_dyn();

		void spawnNoteHoldCover(::hx::Null< Float >  x,::hx::Null< Float >  y, ::Dynamic data, ::objects::Note note, ::objects::StrumNote strum, ::Dynamic playbackRate);
		::Dynamic spawnNoteHoldCover_dyn();
