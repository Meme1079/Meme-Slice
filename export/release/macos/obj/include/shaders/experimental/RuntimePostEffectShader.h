...
#define INCLUDED_shaders_experimental_RuntimePostEffectShader
...
class HXCPP_CLASS_ATTRIBUTES RuntimePostEffectShader_obj : public  ::flixel::addons::display::FlxRuntimeShader_obj
{
	...
	public:
		enum { _hx_ClassId = 0x14221018 };

		void __construct(::String fragmentSource,::String vertexSource);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="shaders.experimental.RuntimePostEffectShader")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"shaders.experimental.RuntimePostEffectShader"); }
		...
		::Dynamic updateFrameInfo_dyn();
		 ...
		 ::openfl::display::ShaderParameter_Float screenCoord;
...
#endif /* INCLUDED_shaders_experimental_RuntimePostEffectShader */ 
